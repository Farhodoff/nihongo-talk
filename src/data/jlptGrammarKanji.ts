    ...
    examples: [
      {
        ...
        romaji:
          'Do not confuse this with the adverb 最も (motto mo), which means extremely. This grammar takes on a',
    ...
    examples: [
      {
        ...
        romaji:
          'The ending で particle may be removed or replaced with a に to become の下に (no moto ni).',
        uz: 'Example Sentences',
      },
      {
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        ja: 'お/ご + Noun + 願う',
        romaji:
          'When used with a noun, it is preceded by either お (o) or ご (go), but is limited to only nouns which',
    ...
    examples: [
      {
        ...
        romaji:
          'This is used to list multiple nouns, it is similar in meaning to と (to) and や (ya), but is mostly used in',
