...
export const JLPT_GRAMMAR_QUESTIONS: JlptGrammarQuestion[] = [
  // === N5 ===
  {
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Fe'lning past/ta shakli] + ことがある. Bu yerda 'こと' (fact/thing) ot bo'lganligi sababli, undan keyin 'が' predlogi keladi: ことがあります.",
  },
  {
    id: 2,
    level: 'N5',
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Fe'lning ます shakli (stem)] + たい. '食べます' -> '食べ' + たい = 食べたい (yegim kelyapti).",
  },
  // === N4 ===
  {
    id: 3,
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Fe'lning ます formasi (stem)] + ながら. '聞きます' (tinglamoq) -> stem qismi '聞き' + ながら = 聞きながら (musiqa tinglayotib dars qilaman).",
  },
  {
    id: 4,
    level: 'N4',
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Fe'lning て shakli] + は + いけません. '吸って' + は + いけません = Chekish mumkin emas.",
  },
  // === N3 ===
  {
    id: 5,
    ...
    correctAnswer: 3,
    explanationUzbek:
      "Qolip: [Fe'lning inkor/nai formasi] + うちに. Inkor shaklidagi fe'lga hech qanday yordamchi predlog (no/na/ni) qo'shmasdan to'g'ridan-to'g'ri 'うちに' birikadi.",
  },
  {
    id: 6,
    level: 'N3',
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Fe'lning lug'at/dictionary formasi] + ことにする = Shaxsiy qaror qabul qilmoq.",
  },
  // === N2 ===
  {
    id: 7,
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Fe'lning lug'at formasi] + わけにはいかない. Muhim imtihon bo'lgani sababli dars qoldirish mumkin emasligini ifodalaydi.",
  },
  {
    id: 8,
    level: 'N2',
    ...
    correctAnswer: 0,
    explanationUzbek:
      'Qolip: [Oddiy shakl] + に違いない. Kuchli ishonch va shubhasiz xulosani anglatadi.',
  },
  // === N1 ===
  {
    id: 9,
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Ot / な-sifat o'zagi] + 極まりない (Kiwamarinai). Haddan ortiq afsusdaman degan rasmiy ma'noda ishlatiladi.",
  },
  {
    id: 10,
    level: 'N1',
    ...
    correctAnswer: 0,
    explanationUzbek:
      "Qolip: [Ot] + を皮切りに (o kawakiri ni). Biror yirik tadbirlar zanjirining boshlang'ich nuqtasini bildiradi.",
  },
];
