...
export const MINNA_N5_LESSONS: Lesson[] = [
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          keyPoints: [
            '📌 1. OT 1 は OT 2 です: Gapning mavzusi (ega) 「は (wa)」 yuklamasi bilan, tasdiq kesimi esa 「です」 bilan ifodalanadi.',
            "📌 2. OT 1 は OT 2 じゃ ありません: 「です」 ning inkor shakli. Og'zaki nutqda 「じゃ ありません」, rasmiyda 「では ありません」 qo'llaniladi.",
            "📌 3. GAP + か: Gap oxiriga 「か」 qo'shib so'roq gap yasaladi. Javob «はい、そうです» yoki «いいえ、～じゃ ありません» bilan beriladi.",
            "📌 4. OT も: Oldingi gapdagi holat takrorlanganda 「は」 o'rniga 'ham' ma'nosidagi 「も」 zarrachasi qo'yiladi.",
            "📌 5. OT 1 の OT 2: Ikki otni bog'lovchi tegishlilik/mansublik zarrachasi (masalan: IMCの 社員 = IMC xodimi).",
            "📌 6. ～さん / ～ちゃん / ～くん: Suhbatdoshga hurmat yoki erkalash qo'shimchasi. O'z ismiga HECH QACHON qo'shilmaydi!",
            '📌 7. Tanishuv odobi: 「初めまして」「どうぞ よろしく お願いします」「こちらこそ よろしく」「失礼ですが、お名前は？」 iboralari.',
          ],
          vocabulary: [
            {
              term: 'わたし',
            ...
            },
            {
              ...
              meaning: 'kim',
              exampleSentence: 'あの 人[ひと]は だれですか。',
              exampleTranslation: 'Anavi kishi kim?',
            },
            {
              term: 'どなた',
              reading: 'どなた',
              meaning: 'kim (hurmat shakli)',
              exampleSentence: 'あの 方[かた]は どなたですか。',
              exampleTranslation: 'U kishi (hurmat shakli) kimlar?',
            },
            {
              ...
              reading: '～さい',
              meaning: '~ yosh',
              exampleSentence: 'テレサちゃんは 9歳[きゅうさい] です。',
              exampleTranslation: 'Teresa 9 yoshda.',
            },
            {
              term: '何歳 (なんさい)',
              reading: 'なんさい',
              meaning: 'necha yosh',
              exampleSentence: 'タワポンさんは 何歳[なんさい]ですか。',
              exampleTranslation: 'Tawapon necha yoshda?',
            },
            {
              term: 'おいくつ',
              reading: 'おいくつ',
              meaning: 'necha yosh (hurmat shakli)',
              exampleSentence: '失礼[しつれい]ですが、おいくつですか。',
              exampleTranslation: 'Kechirasiz, yoshingiz nechada?',
            },
            {
              term: 'はい',
              reading: 'はい',
            ...
            },
            {
              term: '失礼ですが (しつれいですが)',
              reading: 'しつれいですが',
              meaning: 'Kechirasiz, ammo... (savol berishdan oldingi muloyim ibora)',
              exampleSentence: '失礼[しつれい]ですが、お名前[なまえ]は？',
              exampleTranslation: 'Kechirasiz, ismingiz nima?',
            },
            {
              term: 'お名前は？ (おなまえは？)',
              reading: 'おなまえは？',
            ...
            },
            {
              term: '初めまして (はじめまして)',
              reading: 'はじめまして',
              meaning: 'Tanishganimdan xursandman (birinchi uchrashuvda aytiladi)',
              exampleSentence: '初[はじ]めまして。マイク・ミラーです。',
              exampleTranslation: 'Tanishganimdan xursandman. Men Mayk Millerman.',
            },
            {
              term: 'どうぞ よろしく [お願いします]',
              reading: 'どうぞ よろしく おねがいします',
              meaning: 'Marhamat, iltifot qiling / Tanishganimdan mamnunman',
              exampleSentence: 'どうぞ よろしく お願[ねが]いします。',
              exampleTranslation: 'Iltifotingizni ayamang / Hamkorlikdan mamnunman.',
            },
            {
              term: 'こちらこそ よろしく [お願いします]',
              reading: 'こちらこそ よろしく おねがいします',
              meaning: "Men ham xursandman / O'zim ham mamnunman",
              exampleSentence: 'こちらこそ よろしく お願[ねが]いします。',
              exampleTranslation: 'Men ham tanishganimdan mamnunman.',
            },
            {
              term: 'こちらは～さんです',
              reading: 'こちらは～さんです',
              meaning: 'Bu kishi janob / xonim ~ (boshqa odamni tanishtirish)',
              exampleSentence: 'こちらは サントスさんです。',
              exampleTranslation: 'Bu kishi janob Santos.',
            },
            {
              term: '～から 来ました (～からきました)',
              reading: '～からきました',
              meaning: '~(davlat nomi)dan keldim / kelganman',
              exampleSentence: 'アメリカから 来[き]ました。',
              exampleTranslation: 'Amerikadan keldim.',
            },
            {
              term: 'アメリカ',
              reading: 'アメリカ',
              meaning: 'Amerika (AQSH)',
              exampleSentence: 'ミラーさんは アメリカから 来[き]ました。',
              exampleTranslation: 'Janob Miller AQSHdan kelgan.',
            },
            {
              term: 'イギリス',
              reading: 'イギリス',
              meaning: 'Buyuk Britaniya (Angliya)',
              exampleSentence: 'ワットさんは イギリス人[じん] です。',
              exampleTranslation: 'Janob Watt ingliz (Buyuk Britaniyalik).',
            },
            {
              term: 'インド',
              reading: 'インド',
              meaning: 'Hindiston',
              exampleSentence: 'グプタさんは インド人[じん] です。',
              exampleTranslation: 'Janob Gupta hindistonlik.',
            },
            {
              term: 'インドネシア',
              reading: 'インドネシア',
              meaning: 'Indoneziya',
              exampleSentence: 'カリナさんは インドネシアから 来[き]ました。',
              exampleTranslation: 'Karina Indoneziyadan kelgan.',
            },
            {
              term: '韓国 (かんこく)',
              reading: 'かんこく',
              meaning: 'Janubiy Koreya',
              exampleSentence: 'イさんは 韓国[かんこく]人[じん] です。',
              exampleTranslation: 'Janob Li janubiy koreyalik.',
            },
            {
              term: 'タイ',
              reading: 'タイ',
              meaning: 'Tailand',
              exampleSentence: 'タワポンさんは タイ人[じん] です。',
              exampleTranslation: 'Tawapon tailandlik.',
            },
            {
              term: '中国 (ちゅうごく)',
              reading: 'ちゅうごく',
              meaning: 'Xitoy',
              exampleSentence: 'ワンさんは 中国[ちゅうごく]から 来[き]ました。',
              exampleTranslation: 'Janob Wang Xitoydan kelgan.',
            },
            {
              term: 'ドイツ',
              reading: 'ドイツ',
              meaning: 'Germaniya',
              exampleSentence: 'シュミットさんは ドイツ人[じん] です。',
              exampleTranslation: 'Janob Schmidt germaniyalik (nemis).',
            },
            {
              term: '日本 (にほん)',
              reading: 'にほん',
              meaning: 'Yaponiya',
              exampleSentence: '山田[やまだ]さんは 日本人[にほんじん] です。',
              exampleTranslation: 'Janob Yamada yaponiyalik.',
            },
            {
              term: 'フランス',
              reading: 'フランス',
              meaning: 'Fransiya',
              exampleSentence: 'マリアさんは フランス人[じん] じゃ ありません。',
              exampleTranslation: 'Mariya fransiyalik emas.',
            },
            {
              term: 'ブラジル',
              reading: 'ブラジル',
              meaning: 'Braziliya',
              exampleSentence: 'サントスさんは ブラジルから 来[き]ました。',
              exampleTranslation: 'Janob Santos Braziliyadan kelgan.',
            },
            {
              term: 'さくら大学 (さくらだいがく)',
              reading: 'さくらだいがく',
              meaning: "Sakura universiteti (o'ylab topilgan nom)",
              exampleSentence: 'ワットさんは さくら大学[だいがく]の 先生[せんせい] です。',
              exampleTranslation: "Janob Watt Sakura universiteti o'qituvchisi.",
            },
            {
              term: '富士大学 (ふじだいがく)',
              reading: 'ふじだいがく',
              meaning: "Fuji universiteti (o'ylab topilgan nom)",
              exampleSentence:
                '木村[きむら]さんは 富士[ふじ]大学[だいがく]の 学生[がくせい] です。',
              exampleTranslation: 'Kimura xonim Fuji universiteti talabasi.',
            },
            {
              term: 'IMC (アイエムシー)',
              reading: 'アイエムシー',
              meaning: 'IMC kompaniyasi (kompyuter dasturlash firmasi)',
              exampleSentence: 'ミラーさんは IMCの 社員[しゃいん] です。',
              exampleTranslation: 'Janob Miller IMC kompaniyasi xodimi.',
            },
            {
              term: 'パワー電気 (パワーでんき)',
              reading: 'パワーでんき',
              meaning: 'Power Denki (elektr texnikasi kompaniyasi)',
              exampleSentence: 'シュミットさんは パワー電気[でんき]の エンジニアです。',
              exampleTranslation: 'Janob Schmidt Power Denki kompaniyasi muhandisi.',
            },
            {
              term: '神戸病院 (こうべびょういん)',
              reading: 'こうべびょういん',
              meaning: 'Kobe shifoxonasi',
              exampleSentence: 'あの 方[かた]は 神戸[こうべ]病院[びょういん]の 医者[いしゃ] です。',
              exampleTranslation: 'U kishi Kobe shifoxonasi shifokori.',
            },
          ],
          grammarRules: [
            {
              ...
              meaning:
                "1) 「は」 yuklamasi: は yuklamasi birikib kelgan so'z gapning mavzusi (egasi) bo'ladi. Diqqat: Mavzu yuklamasi bo'lib kelganda 「は」 harfi 'ha' emas, balki 'wa' deb o'qiladi.\n2) 「です」: Kesim vazifasini bajaruvchi tasdiq bog'lamasi ('dir/man/san/miz/siz/lar'). So'zlovchining suhbatdoshga nisbatan muloyim va hurmat ohangini bildiradi.",
              usageNotes:
                'Minna no Nihongo 1-darsning eng asosiy bazaviy formulasi. Har bir N5 testida tushadi.',
              examples: [
                {
                ...
                {
                  sentence: 'わたしは 会社員[かいしゃいん] です。',
                  translation: 'Men firma xodimiman.',
                },
              ],
            },
            {
              pattern: 'OT 1 は OT 2 じゃ ありません (では ありません)',
              meaning:
                "「です」 tasdiq bog'lamasining hozirgi zamon inkor shaklidir ('emas').\n- 「じゃ ありません」 — kundalik og'zaki muloqotda keng qo'llaniladi.\n- 「では ありません」 — rasmiy uslub, ma'ruza va yozma nutqda qo'llaniladi (bu yerda ham 「は」 harfi 'wa' deb o'qiladi).",
              usageNotes:
                "Inkor gaplarda ot o'zgarmaydi, faqat 'desu' o'rniga 'ja arimasen' qo'yiladi.",
              examples: [
                {
                ...
                {
                  sentence: 'ミラーさんは 医者[いしゃ] じゃ ありません。',
                  translation: 'Janob Miller shifokor emas.',
                },
              ],
            },
            {
              pattern: "GAP + か (So'roq gap va javoblar)",
              meaning:
                "1) So'roq gap yasash: Yapon tilida darak gap oxiriga 「か」 yuklamasini qo'shish bilan so'roq gap yasaladi. So'z tartibi mutlaqo o'zgarmaydi, oxirgi ohang ko'tariladi.\n2) Ha / Yo'q javoblari: Umumiy savollarga javob «はい (ha)» yoki «いいえ (yo'q)» bilan boshlanadi:\n- 「はい、そうです。」 (Ha, shunday.)\n- 「いいえ、違[ちが]います。」 yoki 「いいえ、～じゃ ありません。」 (Yo'q, unday emas / emasman.)\n3) So'roq so'zli gaplar: Bilmoqchi bo'lgan ma'lumot o'rniga so'roq so'z qo'yiladi (だれ / どなた = kim; 何歳 / おいくつ = necha yosh).",
              usageNotes:
                "Yapon tilida so'roq gaplarda savol belgisi (?) o'rniga faqat 'か' va nuqta qo'yilishi ham mumkin.",
              examples: [
                {
                ...
                {
                  sentence: '･･･はい、アメリカ人[じん] です。',
                  translation: '...Ha, amerikalik.',
                },
                {
                  sentence: 'あの 方[かた]は どなたですか。',
                  translation: 'U kishi (hurmat shakli) kimlar?',
                },
              ],
            },
            {
              pattern: 'OT も (O\'xshashlik - "ham" yuklamasi)',
              meaning:
                "Oldingi gapda aytilgan belgi yoki holat keyingi shaxs/predmetga ham tegishli bo'lganda, 「は」 o'rniga 「も (ham)」 yuklamasi qo'yiladi.",
              usageNotes:
                "O'zbek tilidagi '-ham' qo'shimchasiga to'g'ri keladi. 'は' bilan 'も' bir vaqtda yonma-yon ishlatilmaydi.",
              examples: [
                {
                  sentence:
                    'ミラーさんは 会社員[かいしゃいん] です。サントスさんも 会社員[かいしゃいん] です。',
                  translation: 'Janob Miller firma xodimi. Janob Santos ham firma xodimi.',
                },
                {
                  sentence: 'わたしも 学生[がくせい] です。',
                  translation: 'Men ham talabaman.',
                },
              ],
            },
            {
              pattern: 'OT 1 の OT 2 (Tegishlilik va mansublik)',
              meaning:
                "「の」 zarrachasi ikki otni bog'laydi. OT 1 OT 2 ni aniqlaydi:\n1) Mansublik: Shaxs qaysi tashkilot, kompaniya yoki o'quv yurtiga tegishli ekanligini bildiradi (IMCの 社員 = IMC firmasi xodimi).\n2) Egalik: Buyumning kimga tegishli ekanligini ifodalaydi (2-darsda kengroq o'rganiladi).",
              usageNotes: "O'zbek tilidagi qaratqich kelishigi (-ning) vazifasini bajaradi.",
              examples: [
                {
                  sentence: 'ミラーさんは IMCの 社員[しゃいん] です。',
                  translation: 'Janob Miller IMC kompaniyasining xodimi.',
                },
                {
                  sentence: 'ワットさんは さくら大学[だいがく]の 先生[せんせい] です。',
                  translation: "Janob Watt Sakura universitetining o'qituvchisi.",
                },
              ],
            },
            {
              pattern: '～さん / ～ちゃん / ～くん (Murojaat suffikslari)',
              meaning:
                "1) 「～さん」: Suhbatdosh yoki 3-shaxs familiyasi/ismiga qo'shiladigan umumiy hurmat qo'shimchasi ('janoblari / xonim'). O'Z ISMIGA HECH QACHON QO'SHILMAYDI!\n2) 「～ちゃん」: Kichik yoshdagi bolalarga (asosan qizlarga yoki yaqin erkalashda) qo'shiladi.\n3) 「～くん」: Yosh yigitlar, o'g'il bolalar yoki tengdosh/quyi erkak hamkasblarga nisbatan ishlatiladi.",
              usageNotes:
                "Yaponlar to'g'ridan-to'g'ri 'anata' (sen/siz) so'zini kam ishlatishadi; buning o'rniga shaxsning familiyasi + 'san' deb murojaat qilish odob hisoblanadi.",
              examples: [
                {
                  sentence: '山田[やまだ]さんは 銀行員[ぎんこういん] です。',
                  translation: 'Janob Yamada bank xodimi.',
                },
                {
                  sentence: 'テレサちゃんは 9歳[きゅうさい] です。',
                  translation: 'Teresa-chan 9 yoshda.',
                },
              ],
            },
            {
              pattern: 'Tanishuv va suhbat odobi iboralari',
              meaning:
                "1) 「初[はじ]めまして」: Birinchi bor ko'rishganda aytiladigan tanishuv so'zi ('Tanishganimdan xursandman').\n2) 「どうぞ よろしく [お願[ねが]いします]」: O'zini tanishtirgach aytiladi ('Iltifotingizni ayamang / Hamkorlikdan xursandman').\n3) 「こちらこそ よろしく お願[ねが]いします」: Suhbatdoshga javoban aytiladi ('Men ham mamnunman').\n4) 「失礼[しつれい]ですが、お名前[なまえ]は？」: Xushmuomala tarzda ism so'rash iborasi ('Kechirasiz, ismingiz nima?').\n5) 「[Mamlakat] から 来[き]ました」: Qayerdan kelganini ifodalash.",
              usageNotes:
                "Yapon madaniyatida tanishuv doimo ta'zim (ojigi) va ushbu iboralar bilan birga olib boriladi.",
              examples: [
                {
                  sentence:
                    '初[はじ]めまして。マイク・ミラーです。アメリカから 来[き]ました。どうぞ よろしく お願[ねが]いします。',
                  translation:
                    'Tanishganimdan xursandman. Mayk Millerman. Amerikadan keldim. Iltifot qiling.',
                },
                {
                  sentence: '失礼[しつれい]ですが、お名前[なまえ]は？',
          ...
          culturalNotes:
            "Yaponiyada yangi tanishganda ta'zim qilinadi (ojigi). Boshqalarga doimo '～san' (yoki yoshiga qarab '～chan', '～くん') qo'shiladi, lekin o'z ismiga HECH QACHON 'san' qo'shilmaydi. Tanishuv 'Hajimemashite' bilan boshlanib, 'Douzo yoroshiku onegaishimasu' bilan yakunlanadi.",
        },
      },
      {
        id: 'ja-minna-l1-s2',
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          keyPoints: [
            "📌 1. これ / それ / あれ / どれ: Mustaqil ko'rsatish olmoshlari. これ (so'zlovchiga yaqin), それ (tinglovchiga yaqin), あれ (ikkalasidan uzoqda), どれ (qaysi biri - so'roq).",
            "📌 2. この / その / あの / どの + OT: Otdan oldin keluvchi ko'rsatish sifatlari (Bu kitob, u soat, anavi mashina). Doimo ot bilan birga qo'llaniladi.",
            "📌 3. そうです / そうじゃありません / 違います: Savollarga tasdiq (Ha, shunday) va inkor (Yo'q, unday emas) berish dialog qolipi.",
            "📌 4. GAP 1 ですか、 GAP 2 ですか: Tanlov savollari (A mi yoki B?). Javobda 'ha/yo'q' aytilmaydi, to'g'ridan-to'g'ri tanlangan variant aytiladi.",
            "📌 5. OT 1 の OT 2: Zarracha 'の' ning mazmun (Avtomobil kitobi) va egalik (Mening sumkam, kimniki) ma'nolari hamda otning tushib qolishi.",
            "📌 6. そうですか: Yangi ma'lumotni eshitganda va tushunganda ishlatiladigan ibora ('Shundaymi? / Tushunarli').",
            "📌 7. Muloqot odobi: Sovg'a berganda 'ほんの気持ちです' (arzimagan sovg'a) va minnatdorchilikda 'どうもありがとうございます' deyiladi.",
          ],
          vocabulary: [
            {
              term: 'これ',
            ...
            },
            {
              ...
              meaning: 'Bundan buyon ko`mak va yordamingizga umid qilaman (yangi tanishuv iborasi)',
              exampleSentence:
                'これから お世話[せわ]に なります。 どうぞ よろしく お願[ねが]いします。',
              exampleTranslation:
                'Bundan buyon yordamingizga umid qilaman. Marhamat, tanishganimdan xursandman.',
            },
            {
              term: 'こちらこそよろしく',
              reading: 'こちらこそよろしく',
              meaning: 'Men ham o`z navbatimda tanishganimdan xursandman / birga bo`lsin',
              exampleSentence: '「どうぞ よろしく。」「こちらこそ よろしく お願[ねが]いします。」',
              exampleTranslation:
                '«Marhamat, tanishganimdan xursandman.» «Men ham o`z navbatimda xursandman.»',
            },
          ],
          grammarRules: [
            {
              pattern: 'これ  /  それ  /  あれ  /  どれ',
              meaning:
                "Mustaqil ko'rsatish olmoshlari buyumlarning masofasini ko'rsatishda ishlatiladi: 「これ」 - so'zlovchining o'ziga yaqin turgan buyumlar uchun ('bu'), 「それ」 - suhbatdoshga (tinglovchiga) yaqin turgan buyumlar uchun ('u, o'sha'), 「あれ」 - ikkala suhbatdoshdan ham birdek uzoqdagi buyumlar uchun ('ana u, anavi'), 「どれ」 - uch va undan ortiq narsadan bittasini so'rash uchun so'roq olmoshi ('qaysi biri?').",
              usageNotes:
                "Bu olmoshlar mustaqil keladi va otdan ajralgan holda qo'llaniladi: 「これ／それ／あれ は [Ot] です。」. Hech qachon 「これ本」 shaklida ot bilan birga qo'shib aytilmaydi.",
              examples: [
                {
                  sentence: 'これは 日本[にほん]の 本[ほん] です。',
                  translation: 'Bu Yaponiya kitobi.',
                },
                {
                  sentence: 'それは 英語[えいご]の 辞書[じしょ] ですか。',
                  translation: "U (sizdagi) ingliz tili lug'atimi?",
                },
                {
                  sentence: 'あれは 誰[だれ]の 傘[かさ] ですか。',
                  translation: 'Anavi kimning soyaboni?',
                },
                {
                  sentence: 'あなたの 鍵[かぎ]は どれですか。',
                  translation: 'Sizning kalitingiz qaysi biri?',
                },
              ],
            },
            {
              pattern: 'この [Ot]  /  その [Ot]  /  あの [Ot]  /  どの [Ot]',
              meaning:
                "Ko'rsatish sifatlari doimo o'zidan keyin ot bilan birga qo'llaniladi: 「この + Ot」 - so'zlovchiga yaqin buyum ('bu kitob'), 「その + Ot」 - suhbatdoshga yaqin buyum ('u soat'), 「あの + Ot」 - ikkalasidan uzoqdagi buyum ('anavi mashina'), 「どの + Ot」 - 'qaysi [ot]?' so'roq birikmasi ('qaysi sumka?').",
              usageNotes:
                "Muhim farq: 「これ」 yakka o'zi keladi (これは本です), 「この」 esa har doim orqasidan ot talab qiladi (この本はわたしのです).",
              examples: [
                {
                ...
                {
                  sentence: 'その 傘[かさ]は あなたのですか。',
                  translation: 'U soyabon siznikimi?',
                },
                {
                  sentence: 'あの 車[くるま]は ドイツの 自動車[じどうしゃ] です。',
                  translation: 'Anavi mashina Germaniya avtomobili.',
                },
                {
                  sentence: 'ミラーさんの 机[つくえ]は どの 机[つくえ] ですか。',
                  translation: 'Janob Millerning stoli qaysi stol?',
                },
              ],
            },
            {
              pattern: 'そうです  /  そうじゃ ありません  /  違います',
              meaning:
                "Narsa-buyum nomini so'ragan savollarga qisqa tasdiq yoki inkor javoblari: 「はい、そうです。」 (Ha, shunday / to'g'ri) tasdiq uchun, 「いいえ、そうじゃ ありません。」 yoki ko'proq ishlatiladigan 「いいえ、違[ちが] います。」 (Yo'q, noto'g'ri / unday emas) inkor uchun ishlatiladi.",
              usageNotes:
                "Agar taxmin noto'g'ri bo'lsa, odatda 'いいえ、違います' dan keyin to'g'ri buyum nomi qo'shib aytiladi.",
              examples: [
                {
                  sentence: 'それは 辞書[じしょ] ですか。 ･･･はい、そうです。',
                  translation: "U lug'atmi? …Ha, shunday.",
                },
                {
                  sentence: 'それは テレホンカードですか。 ･･･いいえ、そうじゃ ありません。',
                  translation: "U telefon kartochkasimi? …Yo'q, unday emas.",
                },
                {
                  sentence:
                    'これは シャープペンシルですか。 ･･･いいえ、違[ちが] います。ボールペンです。',
                  translation: "Bu mexanik qalammi? …Yo'q, noto'g'ri. Sharikli ruchka.",
                },
              ],
            },
            {
              pattern: 'GAP 1 ですか、 GAP 2 ですか （Tanlov / Muqobil savoli）',
              meaning:
                "Ikki yoki undan ortiq variantdan birini tanlab javob berish so'ralganda 'GAP 1 ですか、 GAP 2 ですか' qolipi ishlatiladi. Bunday savollarga javob berganda 「はい」 (ha) yoki 「いいえ」 (yo'q) ishlatilmaydi, to'g'ridan-to'g'ri tanlangan variant aytiladi.",
              usageNotes:
                "JLPT N5 testlarida tez-tez uchraydigan qoida: Tanlov savoliga hech qachon 'ha' yoki 'yo'q' deb javob berilmaydi.",
              examples: [
                {
                  sentence: 'これは 「９」ですか、「７」ですか。 ･･･「９」です。',
                  translation: 'Bu «9» mi yoki «7»? …«9».',
                },
                {
                  sentence: 'それは ボールペンですか、シャープペンシルですか。 ･･･ボールペンです。',
                  translation: 'U sharikli ruchkami yoki mexanik qalammi? …Sharikli ruchka.',
                },
              ],
            },
            {
              pattern: 'OT 1 の OT 2',
              meaning:
                "2-darsda 「の」 zarrachasining 2 ta asosiy vazifasi o'rganiladi: 1) Mazmun/Tarkib: OT 1 OT 2 nima haqida ekanini bildiradi (masalan, 自動車の本 - avtomobillar kitobi, 日本語のテープ - yapon tili lentasi). 2) Egalik/Tegishlilik: OT 1 OT 2 ning egasini bildiradi (masalan, わたしの傘 - mening soyabonim, 佐藤さんの手帳 - Sato xonimning daftarchasi).",
              usageNotes:
                "Otning tushib qolishi: Agar gap nima haqida ketayotgani kontekstdan aniq bo'lsa, OT 2 tushib qolishi mumkin: 「これは 誰の 鞄ですか。 ･･･山田さんの（鞄）です。」. Ammo OT 2 inson (masalan, 社員 - xodim) bo'lsa, tushib qolmaydi.",
              examples: [
                {
                  sentence: 'これは コンピューターの 本[ほん] です。',
                  translation: 'Bu kompyuter haqidagi kitob.',
                },
                {
                  sentence: 'これは 日本語[にほんご]の テープです。',
                  translation: 'Bu yapon tili lentasi.',
                },
                {
                  sentence: 'あれは 誰[だれ]の 鞄[かばん]ですか。 ･･･佐藤[さとう]さんのです。',
                  translation: 'Anavi kimning sumkasi? …Sato xonimniki.',
                },
                {
                  sentence: 'この 傘[かさ]は あなたのですか。 ･･･いいえ、わたしのでは ありません。',
                  translation: "Bu soyabon siznikimi? …Yo'q, meniki emas.",
                },
              ],
            },
            {
              pattern: 'そうですか',
              meaning:
                "Suhbatdosh aytgan yangi ma'lumotni qabul qilib olganda va uni tushunganlikni ifodalashda intonatsiyani pasaytirib 「そうですか。」 deb aytiladi ('Ha, shundaymi? / Tushunarli').",
              usageNotes:
                "«そうですか» ning oxirgi ohangi ko'tarilsa savol ('Rostdanmi?') bo'ladi, pasaysa esa yangi axborotni qabul qilish ('Tushundim') bo'ladi.",
              examples: [
                {
                  sentence:
                    'この 傘[かさ]は あなたのですか。 ･･･いいえ、違[ちが]います。シュミットさんのです。 ･･･そうですか。',
                  translation:
                    "Bu soyabon siznikimi? …Yo'q, Shmit janoblariniki. …Ha shundaymi (tushunarli).",
                },
              ],
            },
            {
              pattern: 'ほんの 気持ちです ／ どうも ありがとうございます',
              meaning:
                "Yapon muloqot etiketida sovg'a taqdim etish va minnatdorchilik bildirish iboralari: Sovg'a berganda kamsuqumlik bilan 「これ、ほんの 気持ち[きもち]です。どうぞ。」 (Bu arzimagan sovg'am, marhamat qabul qiling) deyiladi. Unga javoban esa minnatdorchilik bilan 「どうも ありがとう ございます。」 (Katta rahmat) deb javob qaytariladi.",
              usageNotes:
                "Yaponiyada qo'shnilar yoki hamkasblar bilan yangi tanishganda 'これからお世話になります' deb sovg'a topshiriladi.",
              examples: [
                {
                  sentence:
                    'これ、ほんの 気持ち[きもち]です。どうぞ。 ･･･どうも ありがとう ございます。',
                  translation: "Bu arzimagan sovg'am. Marhamat. …Katta rahmat!",
                },
              ],
            },
          ],
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          keyPoints: [
            "📌 1. ここ / そこ / あそこ / どこ: Joyni ko'rsatish olmoshlari (bu yer, u yer, anavi yer, qayer).",
            "📌 2. こちら / そちら / あちら / どちら: Yo'nalish va o'rin-joyning xushmuomala (muloyim) shakli.",
            '📌 3. OT 1 は OT 2 (joy) です: Shaxs yoki buyumning qayerda joylashganini bildirish (masalan: お手洗いは あそこです).',
            "📌 4. どこ / どちら: Joyni so'rash ('qayer') hamda mamlakat, firma yoki o'quv yurtini ehtirom bilan so'rash.",
            '📌 5. OT 1 (davlat / kompaniya) の OT 2 (mahsulot): Mahsulot qayerda ishlab chiqarilgani (masalan: 日本の 車, スイスの 時計).',
            "📌 6. お国 (Hurmat 'お' prefiksi): Suhbatdoshning vatani va buyumlariga hurmat bildirish.",
            '📌 7. Narx-navo va xarid qilish: 「いくらですか」「～階 (なんがい)」「～を 見せてください」「～を ください」「～で ございます」.',
          ],
          vocabulary: [
            {
              term: 'ここ',
            ...
            },
            {
              term: 'こちら',
              reading: 'こちら',
              meaning: 'bu tomon / bu yer (muloyim) / bu kishi (hurmat shakli)',
              exampleSentence: '受付[うけつけ]は こちらで ございます。',
              exampleTranslation: 'Qabulxona bu tarafda.',
            },
            {
              term: 'そちら',
              reading: 'そちら',
              meaning: "u tomon / o'sha yer (muloyim) / siz (muloyim)",
              exampleSentence: 'そちらは 会議室[かいぎしつ] ですか。',
              exampleTranslation: 'U taraf majlislar xonasimi?',
            },
            {
              term: 'あちら',
              reading: 'あちら',
              meaning: 'ana u tomon / ana u yer (muloyim) / ana u kishi (hurmat shakli)',
              exampleSentence: 'エレベーターは あちらで ございます。',
              exampleTranslation: 'Lift ana u tarafda.',
            },
            {
              term: 'どちら',
              reading: 'どちら',
              meaning: 'qaysi tomon / qayer (muloyim) / kim (hurmat shakli)',
              exampleSentence: 'お国[くに]は どちらですか。',
              exampleTranslation: 'Qayerdansiz? (Qaysi davlatdansiz?)',
            },
            {
              term: '教室 (きょうしつ)',
              reading: 'きょうしつ',
              meaning: 'sinf, auditoriya, darsxona',
              exampleSentence: '教室[きょうしつ]で 日本語[にほんご]を 勉強[べんきょう]します。',
              exampleTranslation: "Darsxonada yapon tilini o'rganamiz.",
            },
            {
              term: '食堂 (しょくどう)',
              reading: 'しょくどう',
              meaning: 'oshxona, bufet',
            ...
            },
            {
              ...
              reading: 'じむしょ',
              meaning: 'idora, ofis',
              exampleSentence: '事務所[じむしょ]は 1階[いっかい] です。',
              exampleTranslation: 'Idora 1-qavatda.',
            },
            {
              term: '会議室 (かいぎしつ)',
              reading: 'かいぎしつ',
              meaning: 'majlislar zali, majlislar xonasi',
              exampleSentence: '3階[さんがい]の 会議室[かいぎしつ]で 会議[かいぎ]を します。',
              exampleTranslation: "3-qavatdagi majlislar zalida yig'ilish o'tkazamiz.",
            },
            {
              term: '受付 (うけつけ)',
              reading: 'うけつけ',
              meaning: 'qabulxona, registratura',
              exampleSentence: '受付[うけつけ]は ロビーに あります。',
              exampleTranslation: 'Qabulxona vestibyulda joylashgan.',
            },
            {
              term: 'ロビー',
              reading: 'ロビー',
              meaning: 'lobbi, dahliz, vestibyul',
              exampleSentence: 'ロビーで 友達[ともだち]を 待[ま]ちます。',
              exampleTranslation: "Vestibyulda do'stimni kutaman.",
            },
            {
              term: '部屋 (へや)',
              reading: 'へや',
              meaning: 'xona',
              exampleSentence: 'わたしの 部屋[へや]は 2階[にかい] です。',
              exampleTranslation: 'Mening xonam 2-qavatda.',
            },
            {
              term: 'お手洗い (おてあらい)',
              reading: 'おてあらい',
              meaning: "hojatxona (muloyim so'z)",
              exampleSentence: 'お手洗[てあら]いは あそこです。',
              exampleTranslation: 'Hojatxona ana u yerda.',
            },
            {
              term: 'トイレ',
              reading: 'トイレ',
              meaning: 'hojatxona (tualet)',
              exampleSentence: 'トイレは どこですか。',
              exampleTranslation: 'Hojatxona qayerda?',
            },
            {
              term: '階段 (かいだん)',
              reading: 'かいだん',
              meaning: 'zina, zinapoya',
              exampleSentence: '階段[かいだん]で 2階[にかい]へ 行[い]きます。',
              exampleTranslation: 'Zina orqali 2-qavatga chiqaman.',
            },
            {
              term: 'エレベーター',
              reading: 'エレベーター',
            ...
            },
            {
              ...
              reading: 'エスカレーター',
              meaning: 'eskalator',
              exampleSentence: 'エスカレーターで 地下[ちか]へ 降[お]ります。',
              exampleTranslation: 'Eskalator bilan pastki qavatga tushaman.',
            },
            {
              term: 'お国 (おくに)',
              reading: 'おくに',
              meaning: 'vatan, mamlakat (hurmat shakli)',
              exampleSentence: 'お国[くに]は どちらですか。',
              exampleTranslation: 'Qaysi mamlakatdansiz?',
            },
            {
              term: '会社 (かいしゃ)',
              reading: 'かいしゃ',
              meaning: 'firma, kompaniya, korxona',
              exampleSentence: '会社[かいしゃ]は どちらですか。',
              exampleTranslation: 'Qaysi kompaniyada ishlaysiz?',
            },
            {
              term: 'うち',
              reading: 'うち',
              meaning: 'uy, xonadon',
              exampleSentence: 'わたしの うちは 東京[とうきょう]です。',
              exampleTranslation: 'Mening uyim Tokioda.',
            },
            {
              term: '電話 (でんわ)',
              reading: 'でんわ',
              meaning: 'telefon',
              exampleSentence: '電話[でんわ]は 2階[にかい]に あります。',
              exampleTranslation: 'Telefon 2-qavatda.',
            },
            {
              term: '靴 (くつ)',
              reading: 'くつ',
              meaning: 'poyafzal, oyoq kiyim',
              exampleSentence: 'これは イタリアの 靴[くつ] です。',
              exampleTranslation: 'Bu Italiya poyafzali.',
            },
            {
              term: 'ネクタイ',
              reading: 'ネクタイ',
              meaning: "bo'yinbog', galstuk",
              exampleSentence: 'この ネクタイは 3,000円[さんぜんえん] です。',
              exampleTranslation: "Bu bo'yinbog' 3,000 yen.",
            },
            {
              term: 'ワイン',
              reading: 'ワイン',
              meaning: 'sharob, vino',
              exampleSentence: 'フランスの ワインを ください。',
              exampleTranslation: 'Fransiya vinosidan bering, iltimos.',
            },
            {
              term: 'たばこ',
              reading: 'たばこ',
              meaning: 'tamaki, sigareta',
              exampleSentence: 'たばこ 売り場[うりば]は どこですか。',
              exampleTranslation: "Tamaki bo'limi qayerda?",
            },
            {
              term: '売り場 (うりば)',
              reading: 'うりば',
              meaning: "savdo bo'limi, savdo rastasi",
              exampleSentence: '靴[くつ] 売り場[うりば]は 1階[いっかい] です。',
              exampleTranslation: "Poyafzal bo'limi 1-qavatda.",
            },
            {
              term: '地下 (ちか)',
              reading: 'ちか',
              meaning: "yer osti, yerto'la (podval)",
              exampleSentence:
                '食料品[しょくりょうひん] 売り場[うりば]は 地下[ちか] 1階[いっかい] です。',
              exampleTranslation: "Oziq-ovqat bo'limi yer osti 1-qavatida.",
            },
            {
              term: '～階 (～かい / ～がい)',
              reading: '～かい',
              meaning: '~-qavat',
              exampleSentence: '会議室[かいぎしつ]は 3階[さんがい] です。',
              exampleTranslation: 'Majlislar xonasi 3-qavatda.',
            },
            {
              term: '何階 (なんがい)',
              reading: 'なんがい',
              meaning: 'nechanchi qavat',
              exampleSentence: '時計[とけい] 売り場[うりば]は 何階[なんがい]ですか。',
              exampleTranslation: "Soat bo'limi nechanchi qavatda?",
            },
            {
              term: '～円 (～えん)',
              reading: '～えん',
              meaning: '~ yen (Yapon pul birligi)',
              exampleSentence: 'この ペンは 150円[ひゃくごじゅうえん] です。',
              exampleTranslation: 'Bu ruchka 150 yen.',
            },
            {
              term: 'いくら',
              reading: 'いくら',
              meaning: 'qancha, qancha turadi (narx)',
              exampleSentence: 'この ネクタイは いくらですか。',
              exampleTranslation: "Bu bo'yinbog' qancha turadi?",
            },
            {
              term: '百 (ひゃく)',
              reading: 'ひゃく',
              meaning: 'yuz (100)',
              exampleSentence: 'この ノートは 100円[ひゃくえん] です。',
              exampleTranslation: 'Bu daftar 100 yen.',
            },
            {
              term: '千 (せん)',
              reading: 'せん',
              meaning: 'ming (1,000)',
              exampleSentence: 'この シャツは 2,000円[にせんえん] です。',
              exampleTranslation: "Bu ko'ylak 2,000 yen.",
            },
            {
              term: '万 (まん)',
              reading: 'まん',
              meaning: "o'n ming (10,000)",
              exampleSentence: 'この カメラは 3万[さんまん]円[えん] です。',
              exampleTranslation: 'Bu kamera 30,000 yen.',
            },
            {
              term: 'すみません。',
              reading: 'すみません',
              meaning: "Kechirasiz / Meni ma'zur tutasiz",
              exampleSentence: 'すみません、トイレは どこですか。',
              exampleTranslation: 'Kechirasiz, hojatxona qayerda?',
            },
            {
              term: '～で ございます',
              reading: '～で ございます',
              meaning: "dir (です ning o'ta xushmuomala shakli)",
              exampleSentence: 'インフォメーションは 1階[いっかい]で ございます。',
              exampleTranslation: "Ma'lumot bo'limi 1-qavatdadir.",
            },
            {
              term: '～を 見せてください (みせてください)',
              reading: 'みせてください',
              meaning: "Iltimos, ~ni ko'rsating",
              exampleSentence: 'その ワインを 見[み]せて ください。',
              exampleTranslation: "Anavi vinoni ko'rsating, iltimos.",
            },
            {
              term: 'じゃ',
              reading: 'じゃ',
              meaning: "U holda / Unday bo'lsa",
              exampleSentence: 'じゃ、その 靴[くつ]を ください。',
              exampleTranslation: "Unday bo'lsa, anavi poyabzalni bering.",
            },
            {
              term: '～を ください',
              reading: 'ください',
              meaning: 'Iltimos, ~ni bering',
              exampleSentence: 'この シャツを ください。',
              exampleTranslation: "Shu ko'ylakni bering, iltimos.",
            },
            {
              term: '新大阪 (しんおおさか)',
              reading: 'しんおおさか',
              meaning: 'Shin-Osaka (Osakadagi bekat nomi)',
              exampleSentence: '新[しん]大[おお]阪[さか]駅[えき]は あそこです。',
              exampleTranslation: 'Shin-Osaka bekati ana u yerda.',
            },
            {
              term: 'イタリア',
              reading: 'イタリア',
              meaning: 'Italiya',
              exampleSentence: 'これは イタリアの 靴[くつ]です。',
              exampleTranslation: 'Bu Italiya poyabzali.',
            },
            {
              term: 'スイス',
              reading: 'スイス',
              meaning: 'Shveytsariya',
              exampleSentence: 'スイスの 時計[とけい]は 有名[ゆうめい]です。',
              exampleTranslation: 'Shveytsariya soatlari mashhurdir.',
            },
          ],
          grammarRules: [
            {
              ...
              meaning:
                "ここ (so'zlovchining oldi - bu yer), そこ (tinglovchining oldi - u yer), あそこ (har ikkalasidan uzoq - ana u yer). こちら, そちら, あちら esa ularning yo'nalish yoki xushmuomala shakli.",
              usageNotes:
                'Minna no Nihongo 3-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '受[うけ]付[つけ]は ここです。',
                  translation: 'Qabulxona bu yerda.',
                },
                {
                  sentence: 'エレベーターは あちらです。',
                  translation: 'Lift ana u tarafda.',
                },
              ],
            },
            {
              ...
              meaning:
                'Predmet yoki insonning qayerda ekanligini bildiradi (Ega + は + joy + です).',
              usageNotes:
                'Minna no Nihongo 3-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'お手[て]洗[あら]いは あそこです。',
                  translation: 'Hojatxona ana u yerda.',
                },
                {
                  sentence: '山田[やまだ]さんは 事務[じむ]所[しょ]です。',
            ...
            },
            {
              pattern: 'どこ／どちら',
              meaning:
                "どこ - 'qayerda?', どちら - 'qaysi tarafda?' (yo'nalish yoki muloyim 'qayerda?'). Suhbatdoshning vatani, korxonasi yoki maktabini so'rashda ham どちら ishlatiladi.",
              usageNotes:
                'Minna no Nihongo 3-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'お手[て]洗[あら]いは どこですか。',
                  translation: 'Hojatxona qayerda? …あそこです。(Ana u yerda).',
                },
                {
                  sentence: '会社[かいしゃ]は どちらですか。… IMCです。',
                  translation: 'Qaysi kompaniyada ishlaysiz? … IMC kompaniyasida.',
                },
              ],
            },
            {
              pattern: 'OT 1 の OT 2 (Ishlab chiqarilgan joy/davlat)',
              meaning:
                "Agar OT 1 davlat yoki kompaniya nomi bo'lsa, OT 2 shu davlatda yoki kompaniyada ishlab chiqarilgan mahsulot ekanini bildiradi (masalan: 日本の 車 = Yaponiya mashinasi).",
              usageNotes:
                'Minna no Nihongo 3-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence:
                    'これは どこの コンピューターですか。… 日本[にほん]の コンピューターです。',
                  translation: 'Bu qayerning kompyuteri? … Yaponiya kompyuteri.',
                },
              ],
            },
            {
              pattern: 'こ／そ／あ／ど olmoshlar jadvali',
              meaning:
                "Ko'rsatish olmoshlari: Buyum (これ/それ/あれ), Buyum+Ot (この/その/あの), Joy (ここ/そこ/あそこ), Yo'nalish/Xushmuomala (こちら/そちら/あちら).",
              usageNotes:
                'Minna no Nihongo 3-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'あそこは 食堂[しょくどう]です。',
                  translation: 'Ana u yer oshxona.',
                },
                {
                  sentence: '電話[でんわ]は 2階[にかい]です。',
                  translation: 'Telefon 2-qavatda.',
                },
              ],
            },
            {
              pattern: 'お国 (お prefiksi)',
              meaning:
                "Suhbatdoshga tegishli tushunchalarga hurmat yuzasidan お prefiksi qo'shiladi (お国, お名前). O'zimizga nisbatan qo'llanilmaydi.",
              usageNotes:
                'Minna no Nihongo 3-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'お国[くに]は どちらですか。… アメリカです。',
                  translation: 'Vataningiz qayer? … Amerika.',
                },
              ],
            },
            {
              pattern: 'いくら (Narx so`rash)',
              meaning:
                "Buyumning narxini so'rashda 'OT は いくらですか' konstruksiyasi ishlatiladi. Javobda son + 円[えん] です qo'yiladi.",
              usageNotes:
                'Minna no Nihongo 3-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence:
                    'この 時計[とけい]は いくらですか。… 18,600円[いっちまん はっせん ろっぴゃくえん]です。',
                  translation: 'Bu soat necha pul? … 18,600 yen.',
                },
              ],
            },
          ],
          culturalNotes:
            "Yapon savdo markazlarida va do'konlarda xaridor kirganda 'いらっしゃいませ' deb kutib olinadi. Pul to'lashda pul patnisga (tsuritray) qo'yiladi, to'g'ridan-to'g'ri qo'lga berilmaydi.",
        },
      },
      {
        id: 'ja-minna-l3-s2',
  ...
  },
  {
    ...
    description:
      "Minna no Nihongo Shokyu 1: 4-dars: Vaqt, Soatlar va Fe'llar (Ertalabdan kechgacha). Darsda yangi so'zlar, audio talaffuzli Furigana misollar va 7 ta asosiy grammatik formula o'rganiladi.",
    estimatedDurationMinutes: 25,
    icon: '🌸',
    steps: [
      {
        ...
        learnData: {
          title: "4-dars: Vaqt, Soatlar va Fe'llar (Ertalabdan kechgacha)",
          subtitle: '第4課：今何時ですか・動詞ます形・時間（～から～まで）',
          explanation:
            "4-dars: Vaqt, Soatlar va Fe'llar bo'yicha to'liq grammatik izohlar, formulalar va Furiganali misollar to'plami.",
          keyPoints: [
            '📌 1. 今[いま] 〜時[じ] 〜分[ふん] です: Vaqt, soat va daqiqalarni ifodalash (4時 = よじ, 9時 = くじ, 7時 = しちじ; 10分 = じゅっぷん, 30分 = 半[はん]).',
            "📌 2. FE’L ます / ません: Xushmuomala hozirgi va kelasi zamon bo'lishli va inkor fe'llar.",
            "📌 3. FE’L ました / ませんでした: Xushmuomala o'tgan zamon bo'lishli va inkor fe'llar.",
            "📌 4. OT (aniq vaqt) に FE’L: Aniq vaqt/soatda harakat bajarilganda 「に」 qo'yiladi (nisbiy vaqtlar 今日[きょう], 明日[あした], 毎朝[まいあさ] bilan に ishlatilmaydi).",
            '📌 5. OT 1 から OT 2 まで: Boshlanish (〜dan) va tugash (〜gacha) vaqti yoki chegarasi.',
            "📌 6. OT 1 と OT 2: Ikkita ot orasida 'va' bog'lovchisi.",
            "📌 7. GAP ね: Hamdardlik, tasdiqlash yoki kelishuv yuklamasi ('shunday-a?', 'ha-ya').",
          ],
          vocabulary: [
            {
              term: '起きます (おきます)',
              reading: 'おきます',
              meaning: "uyg'onmoq, o'rnidan turmoq",
            ...
            },
            {
              term: '勉強します (べんきょうします)',
              reading: 'べんきょうします',
              meaning: "dars qilmoq, o'qimoq",
              exampleSentence: '毎晩[まいばん] 日本語[にほんご]を 勉強[べんきょう]します。',
              exampleTranslation: "Har kecha yapon tilini o'rganaman.",
            },
            {
              term: '終わります (おわります)',
              reading: 'おわります',
              meaning: "tugamoq, tamom bo'lmoq",
            ...
            },
            {
              term: 'デパート',
              reading: 'デパート',
              meaning: 'univermag, savdo markazi',
              exampleSentence: 'デパートは 10時[じゅうじ]からです。',
              exampleTranslation: 'Univermag soat 10 dan ochiladi.',
            },
            {
              term: '銀行 (ぎんこう)',
              reading: 'ぎんこう',
              meaning: 'bank',
              exampleSentence: '銀行[ぎんこう]は 3時[さんじ]までです。',
              exampleTranslation: 'Bank soat 3 gacha ochiq.',
            },
            {
              term: '郵便局 (ゆうびんきょく)',
              reading: 'ゆうびんきょく',
              meaning: "pochta bo'limi",
              exampleSentence: '郵便局[ゆうびんきょく]は どこですか。',
              exampleTranslation: 'Pochta qayerda?',
            },
            {
              term: '図書館 (としょかん)',
              reading: 'としょかん',
              meaning: 'kutubxona',
              exampleSentence: '図書館[としょかん]で 勉強[べんきょう]します。',
              exampleTranslation: 'Kutubxonada dars qilaman.',
            },
            {
              term: '美術館 (びじゅつかん)',
              reading: 'びじゅつかん',
              meaning: "muzey, san'at galereyasi",
              exampleSentence: '美術館[びじゅつかん]は 休[やす]みです。',
              exampleTranslation: 'Muzey bugun yopiq.',
            },
            {
              term: '今 (いま)',
              reading: 'いま',
            ...
            },
            {
              term: '～時 (～じ)',
              reading: '～じ',
              meaning: "~soat (vaqt o'lchovi)",
              exampleSentence: '今[いま] 4時[よじ]です。',
              exampleTranslation: 'Hozir soat 4.',
            },
            {
              term: '～分 (～ふん / ～ぷん)',
              reading: '～ふん / ～ぷん',
              meaning: '~daqiqa',
              exampleSentence: '今[いま] 2時10分[にじ じゅっぷん]です。',
              exampleTranslation: "Hozir soat 2 dan 10 daqiqa o'tdi.",
            },
            {
              term: '半 (はん)',
              reading: 'はん',
              meaning: 'yarim (30 daqiqa)',
              exampleSentence: '今[いま] 9時半[くじはん]です。',
              exampleTranslation: 'Hozir soat 9 yarim.',
            },
            {
              term: '何時 (なんじ)',
              reading: 'なんじ',
              meaning: 'soat necha',
              exampleSentence: '何時[なんじ]に 起[お]きますか。',
              exampleTranslation: "Soat nechada uyg'onasiz?",
            },
            {
              term: '何分 (なんぷん)',
              reading: 'なんぷん',
              meaning: 'necha daqiqa',
              exampleSentence: '今[いま] 何分[なんぷん]ですか。',
              exampleTranslation: 'Hozir nechanchi daqiqa?',
            },
            {
              term: '午前 (ごぜん)',
              reading: 'ごぜん',
              meaning: 'tushgacha, ertalab (AM)',
              exampleSentence: '午前[ごぜん] 9時[くじ]に 始[はじ]まります。',
              exampleTranslation: 'Ertalab soat 9 da boshlanadi.',
            },
            {
              term: '午後 (ごご)',
              reading: 'ごご',
              meaning: 'tushdan keyin (PM)',
              exampleSentence: '午後[ごご] 5時[ごじ]に 終[お]わります。',
              exampleTranslation: 'Tushdan keyin soat 5 da tugaydi.',
            },
            {
              term: '朝 (あさ)',
              reading: 'あさ',
              meaning: 'ertalab, tong',
              exampleSentence: '朝[あさ] パンを 食[た]べます。',
              exampleTranslation: 'Ertalab non yeyman.',
            },
            {
              term: '昼 (ひる)',
              reading: 'ひる',
              meaning: 'kunduz, peshin',
              exampleSentence: '昼[ひる] 12時[じゅうにじ]に 休[やす]みます。',
              exampleTranslation: 'Peshin soat 12 da dam olamiz.',
            },
            {
              term: '晩 (ばん) / 夜 (よる)',
              reading: 'ばん / よる',
              meaning: 'oqshom, kechasi',
              exampleSentence: '晩[ばん] 勉強[べんきょう]します。',
              exampleTranslation: 'Kechqurun dars qilaman.',
            },
            {
              term: '一昨日 (おととい)',
              reading: 'おととい',
              meaning: "o'tgan kuni, avvalgi kun",
              exampleSentence: '一昨日[おととい] 休[やす]みました。',
              exampleTranslation: "O'tgan kuni dam oldim.",
            },
            {
              term: '昨日 (きのう)',
              reading: 'きのう',
              meaning: 'kecha',
              exampleSentence: '昨日[きのう] 勉強[べんきょう]しました。',
              exampleTranslation: 'Kecha dars qildim.',
            },
            {
              term: '今日 (きょう)',
              reading: 'きょう',
              meaning: 'bugun',
              exampleSentence: '今日[きょう] 働[はたら]きます。',
              exampleTranslation: 'Bugun ishlayman.',
            },
            {
              term: '明日 (あした)',
              reading: 'あした',
              meaning: 'ertaga',
              exampleSentence: '明日[あした] 休[やす]みます。',
              exampleTranslation: 'Ertaga dam olaman.',
            },
            {
              term: '明後日 (あさって)',
              reading: 'あさって',
              meaning: 'indinga, ertadan keyin',
              exampleSentence: '明後日[あさって] 勉強[べんきょう]します。',
              exampleTranslation: 'Indinga dars qilaman.',
            },
            {
              term: '今朝 (けさ)',
              reading: 'けさ',
              meaning: 'bugun ertalab',
              exampleSentence: '今朝[けさ] 6時[ろくじ]に 起[お]きました。',
              exampleTranslation: "Bugun ertalab soat 6 da uyg'ondim.",
            },
            {
              term: '今晩 (こんばん)',
              reading: 'こんばん',
              meaning: 'bugun kechqurun',
              exampleSentence: '今晩[こんばん] テレビを 見[み]ます。',
              exampleTranslation: "Bugun kechqurun televizor ko'raman.",
            },
            {
              term: '休み (やすみ)',
              reading: 'やすみ',
              meaning: "dam olish, ta'til",
              exampleSentence: '土曜日[どようび]は 休[やす]みです。',
              exampleTranslation: 'Shanba - dam olish kuni.',
            },
            {
              term: '昼休み (ひるやすみ)',
              reading: 'ひるやすみ',
              meaning: 'tushlik tanaffusi',
              exampleSentence: '昼休[ひるやす]みは 12時[じゅうにじ]からです。',
              exampleTranslation: 'Tushlik tanaffusi soat 12 dan boshlanadi.',
            },
            {
              term: '毎朝 (まいあさ)',
              reading: 'まいあさ',
              meaning: 'har tong, har ertalab',
              exampleSentence: '毎朝[まいあさ] 新聞[しんぶん]を 読[よ]みます。',
              exampleTranslation: "Har kuni ertalab gazeta o'qiyman.",
            },
            {
            ...
            },
            {
              ...
              reading: 'まいにち',
              meaning: 'har kuni',
              exampleSentence: '毎日[まいにち] 働[はたら]きます。',
              exampleTranslation: 'Har kuni ishlayman.',
            },
            {
              term: '月曜日 (げつようび)',
              reading: 'げつようび',
              meaning: 'dushanba',
              exampleSentence: '月曜日[げつようび]から 働[はたら]きます。',
              exampleTranslation: 'Dushanbadan ishlayman.',
            },
            {
              term: '火曜日 (かようび)',
              reading: 'かようび',
              meaning: 'seshanba',
              exampleSentence: '火曜日[かようび]に テストが あります。',
              exampleTranslation: 'Seshanba kuni test bor.',
            },
            {
              term: '水曜日 (すいようび)',
              reading: 'すいようび',
              meaning: 'chorshanba',
              exampleSentence: '水曜日[すいようび]は 図書館[としょかん]へ 行[い]きます。',
              exampleTranslation: 'Chorshanba kuni kutubxonaga boraman.',
            },
            {
              term: '木曜日 (もくようび)',
              reading: 'もくようび',
              meaning: 'payshanba',
              exampleSentence: '木曜日[もくようび]に 会議[かいぎ]が あります。',
              exampleTranslation: 'Payshanba kuni majlis bor.',
            },
            {
              term: '金曜日 (きんようび)',
              reading: 'きんようび',
              meaning: 'juma',
              exampleSentence: '金曜日[きんようび]まで 働[はたら]きます。',
              exampleTranslation: 'Jumagacha ishlayman.',
            },
            {
              term: '土曜日 (どようび)',
              reading: 'どようび',
              meaning: 'shanba',
              exampleSentence: '土曜日[どようび]は 休[やす]みです。',
              exampleTranslation: 'Shanba kuni dam olaman.',
            },
            {
              term: '日曜日 (にちようび)',
              reading: 'にちようび',
              meaning: 'yakshanba',
              exampleSentence: '日曜日[にちようび]は どこも 行[い]きません。',
              exampleTranslation: 'Yakshanba hech qayerga bormayman.',
            },
            {
              term: '何曜日 (なんようび)',
              reading: 'なんようび',
              meaning: 'haftaning qaysi kuni',
              exampleSentence: '今日[きょう]は 何曜日[なんようび]ですか。',
              exampleTranslation: 'Bugun haftaning qaysi kuni?',
            },
            {
              term: '番号 (ばんごう)',
              reading: 'ばんごう',
              meaning: 'raqam, nomer',
              exampleSentence: '電話[でんわ]番号[ばんごう]は 何番[なんばん]ですか。',
              exampleTranslation: 'Telefon raqamingiz necha?',
            },
            {
              term: '何番 (なんばん)',
              reading: 'なんばん',
              meaning: 'nechanchi raqam',
              exampleSentence: 'あなたの 部屋[へや]は 何番[なんばん]ですか。',
              exampleTranslation: 'Xonangiz nechanchi raqam?',
            },
            {
              term: '～から',
              reading: '～から',
              meaning: '~dan (boshlanish vaqti)',
              exampleSentence: '9時[くじ]からです。',
              exampleTranslation: 'Soat 9 dan boshlanadi.',
            },
            {
              term: '～まで',
              reading: '～まで',
              meaning: '~gacha (tugash vaqti)',
              exampleSentence: '5時[ごじ]までです。',
              exampleTranslation: 'Soat 5 gacha.',
            },
            {
              term: '～と～',
              reading: '～と～',
              meaning: "~va~ (otlarni bog'lovchi)",
              exampleSentence: '土曜日[どようび]と 日曜日[にちようび]は 休みです。',
              exampleTranslation: 'Shanba va yakshanba dam olish kuni.',
            },
            {
              term: '大変ですね (たいへんですね)',
              reading: 'たいへんですね',
              meaning: 'Qiyin ekan-a! / Mashaqqatli ekan-a!',
              exampleSentence:
                '毎日[まいにち] 10時[じゅうじ]まで 勉強[べんきょう]します。… 大変[たいへん]ですね。',
              exampleTranslation: 'Har kuni soat 10 gacha dars qilaman. … Qiyin ekan-a!',
            },
            {
              term: 'えーと',
              reading: 'えーと',
              meaning: "Xo'sh... / Haligi...",
              exampleSentence: 'えーと、871の 6813です。',
              exampleTranslation: "Xo'sh... 871-6813.",
            },
            {
              term: 'そちら',
              reading: 'そちら',
              meaning: 'siz tomoningiz, u taraf',
              exampleSentence: 'そちらは 何時[なんじ]までですか。',
              exampleTranslation: 'Siz tomoningizda soat nechagacha ochiq?',
            },
            {
              term: 'ニューヨーク',
              reading: 'ニューヨーク',
              meaning: 'Nyu-York',
              exampleSentence: 'ニューヨークは 今[いま] 午前[ごぜん] 4時[よじ]です。',
              exampleTranslation: 'Nyu-Yorkda hozir ertalabki soat 4.',
            },
            {
              term: 'ペキン',
              reading: 'ペキン',
              meaning: 'Pekin',
              exampleSentence: 'ペキンは 今[いま] 午後[ごご] 5時[ごじ]です。',
              exampleTranslation: 'Pekinda hozir tushdan keyin soat 5.',
            },
            {
              term: 'ロンドン',
              reading: 'ロンドン',
              meaning: 'London',
              exampleSentence: 'ロンドンは 今[いま] 午前[ごぜん] 1時[いちじ]です。',
              exampleTranslation: 'Londonda hozir tunda soat 1.',
            },
            {
              term: 'バンコク',
              reading: 'バンコク',
              meaning: 'Bangkok',
              exampleSentence: 'バンコクは 今[いま] 午後[ごご] 4時[よじ]です。',
              exampleTranslation: 'Bangkokda hozir tushdan keyingi soat 4.',
            },
            {
              term: 'ロサンゼルス',
              reading: 'ロサンゼルス',
              meaning: 'Los-Anjeles',
              exampleSentence: 'ロサンゼルスは 午前[ごぜん] 1時[いちじ]です。',
              exampleTranslation: 'Los-Anjelesda tunda soat 1.',
            },
          ],
          grammarRules: [
            {
              ...
              meaning:
                "Soat va daqiqalarni bildirish formulasi. Soatlar uchun son + 時 (じ), daqiqalar uchun son + 分 (ふん / ぷん) qo'shiladi. 💡 Maxsus talaffuzlar: 4時 = よじ (shiji yoki yonji emas), 7時 = しちじ (nanaji emas), 9時 = くじ (kyuuji emas). Daqiqalarda: 1分 = いっぷん, 3分 = さんぷん, 6分 = ろっぷん, 8分 = はっぷん, 10分 = じゅっぷん. 30分 uchun 半 (はん) so'zi ham ishlatiladi.",
              usageNotes:
                'Minna no Nihongo 4-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '今[いま] 4時[よじ] 5分[ごふん]です。',
                  translation: "Hozir soat 4 dan 5 daqiqa o'tdi.",
                },
                {
                  sentence: '今[いま] 9時半[くじはん]です。',
                  translation: "Hozir soat to'qqiz yarim (9:30).",
                },
                {
                  sentence: '東京[とうきょう]は 今[いま] 何時[なんじ]ですか。',
                  translation: 'Tokioda hozir soat necha?',
                },
              ],
            },
            {
              pattern: 'FE’L ます / FE’L ません',
              meaning:
                "Xushmuomala bo'lishli va inkor fe'llar. 「〜ます」 hozirgi va kelasi zamonda doimiy takrorlanadigan odatiy harakatlar yoki kelajakda bajarilishi rejalashtirilgan harakatlarni ifodalaydi. Inkor shakli 「〜ません」.",
              usageNotes:
                'Minna no Nihongo 4-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'わたしは 毎朝[まいあさ] 6時[ろくじ]に 起[お]きます。',
                  translation: "Men har kuni ertalab soat 6 da uyg'onaman.",
                },
                {
                  sentence: '明日[あした] 勉強[べんきょう]します。',
                  translation: 'Ertaga dars qilaman.',
                },
                {
                  sentence: '日曜日[にちようび]は 働[はたら]きません。',
                  translation: 'Yakshanba kuni ishlamayman.',
                },
              ],
            },
            {
              pattern: 'FE’L ました / FE’L ませんでした',
              meaning:
                "Fe'llarning o'tgan zamon xushmuomala shakllari. Bo'lishli o'tgan zamon: 「〜ました」. Bo'lishsiz (inkor) o'tgan zamon: 「〜ませんでした」.",
              usageNotes:
                'Minna no Nihongo 4-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'きのう 勉強[べんきょう]しました。',
                  translation: 'Kecha dars qildim.',
                },
                {
                  sentence: 'きのう 働[はたら]きませんでした。',
                  translation: 'Kecha ishlamadim.',
                },
                {
                  sentence: 'おととい 勉強[べんきょう]しましたか。… いいえ、しませんでした。',
                  translation: "O'tgan kuni dars qildingizmi? … Yo'q, qilmadim.",
                },
              ],
            },
            {
              pattern: 'OT (aniq vaqt) に FE’L',
              meaning:
                "Harakat aniq vaqt yoki soatda sodir bo'lganda vaqt bildiruvchi so'zdan keyin 「に」 zarrachasi qo'yiladi (masalan: 6時に 起きます, 月曜日に テストがあります). ⚠️ MUHIM QOIDA: Raqam qatnashmagan nisbiy vaqt so'zlari (今日, 明日, きのう, 毎朝, 毎晩, 毎日, 今朝, 今晩) dan keyin 「に」 qo'yilMAYDI!",
              usageNotes:
                'Minna no Nihongo 4-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '毎朝[まいあさ] 7時[しちじ]に 起[お]きます。',
                  translation: "Har tong soat 7 da uyg'onaman.",
                },
                {
                  sentence: '明日[あした] 働[はたら]きます。（明日[あした]に は xato!）',
                  translation: "Ertaga ishlayman. (明日 dan keyin に qo'yilmaydi).",
                },
              ],
            },
            {
              ...
              meaning:
                "「から」 - harakat yoki vaqtning boshlanish chegarasini (~dan), 「まで」 esa tugash chegarasini (~gacha) bildiradi. Ular gapda alohida ham qo'llanilishi mumkin.",
              usageNotes:
                'Minna no Nihongo 4-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '9時[くじ]から 5時[ごじ]まで 働[はたら]きます。',
                  translation: 'Soat 9 dan 5 gacha ishlayman.',
                },
                {
                  sentence: '昼休[ひるやす]みは 12時[じゅうにじ]からです。',
                  translation: 'Tushlik tanaffusi soat 12 dan.',
                },
                {
                  sentence: '銀行[ぎんこう]は 3時[さんじ]までです。',
                  translation: 'Bank soat 3 gacha ochiq.',
                },
              ],
            },
            {
              pattern: 'OT 1 と OT 2',
              meaning:
                "Ikki otni 'va' bog'lovchisi orqali sanab o'tishda 「と」 qo'llanadi. Faqat otlarni bog'laydi, gaplarni emas!",
              usageNotes:
                'Minna no Nihongo 4-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence:
                    '銀行[ぎんこう]の 休[やす]みは 土曜日[どようび]と 日曜日[にちようび]です。',
                  translation: 'Bankning dam olish kunlari shanba va yakshanbadir.',
                },
              ],
            },
            {
              pattern: 'GAP ね',
              meaning:
                "Gapning oxirida keladigan 「ね」 yuklamasi tinglovchidan ma'qullash, tasdiqlash yoki hamdardlik bildirishda qo'llanadi ('shunday emasmi?', 'ha-ya', 'qiyin-a').",
              usageNotes:
                'Minna no Nihongo 4-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence:
                    '毎日[まいにち] 10時[じゅうじ]まで 勉強[べんきょう]します。… 大変[たいへん]ですね。',
                  translation: 'Har kuni soat 10 gacha dars qilaman. … Qiyin ekan-a!',
                },
                {
                  sentence:
                    '佐藤[さとう]さんの 電話[でんわ]番号[ばんごう]は 871の6813ですね。… はい、そうです。',
                  translation: 'Sato xonimning telefon raqami 871-6813, shundaymi? … Ha, shunday.',
                },
              ],
            },
          ],
          culturalNotes:
            "Yaponiyada poyezdlar va avtobuslar daqiqasigacha aniq ishlaydi. Banklar va pochtalar qat'iy jadval asosida ishlaydi (odatda 9:00 dan 15:00 yoki 17:00 gacha). Kech qolish (chikoku) yapon jamiyatida o'ta salbiy baholanadi.",
        },
      },
      {
        id: 'ja-minna-l4-s2',
  ...
  },
  {
    ...
    description:
      "Minna no Nihongo Shokyu 1: 5-dars: Harakat, Transport va Safar. Darsda yangi so'zlar, audio talaffuzli Furigana misollar va 7 ta asosiy grammatik formula o'rganiladi.",
    estimatedDurationMinutes: 25,
    icon: '🌸',
    steps: [
      {
        ...
        learnData: {
          title: '5-dars: Harakat, Transport va Safar',
          subtitle: '第5課：行く・来る・帰る・交通手段・日時',
          explanation:
            "5-dars: Harakat, Transport va Safar bo'yicha to'liq grammatik izohlar, formulalar va Furiganali misollar to'plami.",
          keyPoints: [
            "📌 1. OT (joy) へ 行きます / 来ます / 帰ります: Boriladigan manzil va harakat yo'nalishi 「へ (e)」 zarrachasi bilan ifodalanadi.",
            "📌 2. どこ [へ] も 行きません / 行きませんでした: Butunlay inkor qilish shakli ('Hech qayerga bormayman / bormadim').",
            "📌 3. OT (transport vositasi) で 行きます / 来ます / 帰ります: Harakatlanish vositasi 「で」 bilan ifodalanadi. ⚠️ Istisno: 歩いて (piyoda) bilan 「で」 qo'yilmaydi!",
            "📌 4. OT (inson/jonli) と FE’L: Harakatni kimdir bilan birgalikda bajarish 「と」 (bilan) bilan ifodalanadi. ⚠️ Yolg'iz harakat uchun 「一人で (ひとりで)」 qo'llanadi.",
            "📌 5. いつ: Vaqtni so'rovchi umumiy 'Qachon?' so'roq olmoshi (orqasidan に qo'yilmaydi).",
            "📌 6. GAP よ: Tinglovchi bilmagan yangi ma'lumotni yetkazish yoki ta'kidlash yuklamasi ('axir', '-ku').",
            "📌 7. Kalendar va Sanalar: Yapon tilida oylar (〜月 / 〜がつ) va kunlar (〜日 / 〜にち). 1日 (ついたち), 14日 (じゅうよっか), 20日 (はつか), 24日 (にじゅうよっか) kabi maxsus o'qilishlar mavjud.",
          ],
          vocabulary: [
            {
              term: '行きます (いきます)',
              reading: 'いきます',
              meaning: 'bormoq',
              exampleSentence: '明日[あした] 京都[きょうと]へ 行[い]きます。',
            ...
            },
            {
              ...
              reading: 'かえります',
              meaning: 'qaytmoq',
              exampleSentence: '午後[ごご] 7時[しちじ]に うちへ 帰[かえ]ります。',
              exampleTranslation: 'Kechqurun soat 7 da uyga qaytaman.',
            },
            {
              term: '学校 (がっこう)',
              reading: 'がっこう',
              meaning: 'maktab',
              exampleSentence: '自転車[じてんしゃ]で 学校[がっこう]へ 行[い]きます。',
            ...
            },
            {
              ...
              exampleSentence: '新宿[しんじゅく]駅[えき]で 電車[でんしゃ]に 乗[の]ります。',
              exampleTranslation: 'Shinjuku bekatida poyezdga minaman.',
            },
            {
              term: '飛行機 (ひこうき)',
              reading: 'ひこうき',
              meaning: 'samolyot',
              exampleSentence: '飛行機[ひこうき]で 日本[にほん]へ 来[き]ました。',
              exampleTranslation: 'Samolyotda Yaponiyaga keldim.',
            },
            {
              term: '船 (ふね)',
              reading: 'ふね',
              meaning: 'kema',
              exampleSentence: '船[ふね]で 島[しま]へ 行[い]きます。',
              exampleTranslation: 'Kemada orolga boraman.',
            },
            {
              term: '電車 (でんしゃ)',
              reading: 'でんしゃ',
              meaning: 'elektr poyezd',
              exampleSentence: '電車[でんしゃ]で 会社[かいしゃ]へ 行[い]きます。',
              exampleTranslation: 'Elektr poyezdda ishga boraman.',
            },
            {
              term: '地下鉄 (ちかてつ)',
              reading: 'ちかてつ',
              ...
              exampleTranslation: 'Tokio metrosi qulaydir.',
            },
            {
              term: '新幹線 (しんかんせん)',
              reading: 'しんかんせん',
              meaning: 'tezyurar poyezd (Shinkansen)',
              exampleSentence: '新幹線[しんかんせん]で 大阪[おおさか]へ 行[い]きます。',
              exampleTranslation: 'Shinkansenda Osakaga boraman.',
            },
            {
              term: 'バス',
              reading: 'バス',
              meaning: 'avtobus',
              exampleSentence: '毎朝[まいあさ] バスで 駅[えき]まで 行[い]きます。',
              exampleTranslation: 'Har tong avtobusda bekatgacha boraman.',
            },
            {
              term: 'タクシー',
              reading: 'タクシー',
              meaning: 'taksi',
              exampleSentence: 'タクシーで 病院[びょういん]へ 行[い]きました。',
              exampleTranslation: 'Taksida shifoxonaga bordim.',
            },
            {
              term: '自転車 (じてんしゃ)',
              reading: 'じてんしゃ',
              meaning: 'velosiped',
              exampleSentence: '駅[えき]まで 自転車[じてんしゃ]で 10分[じゅっぷん]です。',
              exampleTranslation: 'Bekatgacha velosipedda 10 daqiqa.',
            },
            {
              term: '歩いて (あるいて)',
              reading: 'あるいて',
              meaning: 'piyoda',
              exampleSentence: '駅[えき]から 歩[ある]いて 帰[かえ]りました。',
              exampleTranslation: 'Bekatdan piyoda qaytdim.',
            },
            {
              term: '人 (ひと)',
              reading: 'ひと',
            ...
            },
            {
              term: '友達 (ともだち)',
              reading: 'ともだち',
              meaning: "do'st, o'rtoq",
              exampleSentence: '友達[ともだち]と 映画[えいが]を 見[み]に行[い]きます。',
              exampleTranslation: "Do'stim bilan kinoga boraman.",
            },
            {
              term: '彼 (かれ)',
              reading: 'かれ',
              meaning: 'u (erkak kishi); yigit (sevgilisi)',
              exampleSentence: '彼[かれ]は 親切[しんせつ]な 人[ひと]です。',
              exampleTranslation: 'U samimiy inson.',
            },
            {
              term: '彼女 (かのじょ)',
              reading: 'かのじょ',
              meaning: 'u (ayol kishi); qiz (sevgilisi)',
              exampleSentence: '彼女[かのじょ]は 日本語[にほんご]の 先生[せんせい]です。',
              exampleTranslation: "U yapon tili o'qituvchisi.",
            },
            {
              term: '家族 (かぞく)',
              reading: 'かぞく',
              meaning: 'oila',
              exampleSentence: '家族[かぞく]と 日本[にほん]へ 来[き]ました。',
              exampleTranslation: 'Oilam bilan Yaponiyaga keldim.',
            },
            {
              term: '一人で (ひとりで)',
              reading: 'ひとりで',
              meaning: "yolg'iz, bir o'zi",
              exampleSentence: '一人[ひとり]で 旅行[りょこう]へ 行[い]きます。',
              exampleTranslation: "Bir o'zim sayohatga boraman.",
            },
            {
              term: '先週 (せんしゅう)',
              reading: 'せんしゅう',
              meaning: 'o’tgan hafta',
              exampleSentence: '先週[せんしゅう] 京都[きょうと]へ 行[い]きました。',
              exampleTranslation: 'O’tgan hafta Kiotoga bordim.',
            },
            {
              term: '今週 (こんしゅう)',
              reading: 'こんしゅう',
              meaning: 'bu hafta',
              exampleSentence: '今週[こんしゅう]は とても 忙[いそが]しいです。',
              exampleTranslation: 'Bu hafta juda bandman.',
            },
            {
              term: '来週 (らいしゅう)',
              reading: 'らいしゅう',
              meaning: 'kelasi hafta',
              exampleSentence: '来週[らいしゅう] テストが あります。',
              exampleTranslation: 'Kelasi hafta test bor.',
            },
            {
              term: '先月 (せんげつ)',
              reading: 'せんげつ',
              meaning: 'o’tgan oy',
              exampleSentence: '先月[せんげつ] 日本[にほん]へ 来[き]ました。',
              exampleTranslation: 'O’tgan oy Yaponiyaga keldim.',
            },
            {
              term: '今月 (こんげつ)',
              reading: 'こんげつ',
              meaning: 'bu oy',
              exampleSentence: '今月[こんげつ]は 祝日[しゅくじつ]が 多[おお]いです。',
              exampleTranslation: 'Bu oyda bayram kunlari ko’p.',
            },
            {
              term: '来月 (らいげつ)',
              reading: 'らいげつ',
              meaning: 'kelasi oy',
              exampleSentence: '来月[らいげつ] 国[くに]へ 帰[かえ]ります。',
              exampleTranslation: 'Kelasi oy yurtimga qaytaman.',
            },
            {
              term: '去年 (きょねん)',
              reading: 'きょねん',
              meaning: 'o’tgan yil',
              exampleSentence: '去年[きょねん] 大学[だいがく]を 卒業[そつぎょう]しました。',
              exampleTranslation: 'O’tgan yili universitetni bitirdim.',
            },
            {
              term: '今年 (ことし)',
              reading: 'ことし',
              meaning: 'bu yil',
              exampleSentence: '今年[ことし] N5を 受[う]けます。',
              exampleTranslation: 'Bu yil N5 imtihonini topshiraman.',
            },
            {
              term: '来年 (らいねん)',
              reading: 'らいねん',
              meaning: 'kelasi yil',
              exampleSentence: '来年[らいねん] 日本[にほん]へ 行[い]きます。',
              exampleTranslation: 'Kelasi yili Yaponiyaga boraman.',
            },
            {
              term: '～月 (～がつ)',
              reading: '～がつ',
              meaning: '~ oy (yil oylari)',
              exampleSentence: '4月[しがつ]から 新[あたら]しい 学校[がっこう]へ 行[い]きます。',
              exampleTranslation: 'Apreldan yangi maktabga boraman.',
            },
            {
              term: '何月 (なんがつ)',
              reading: 'なんがつ',
              meaning: 'qaysi oy',
              exampleSentence: 'あなたのお誕生日[たんじょうび]は 何月[なんがつ]ですか。',
              exampleTranslation: 'Tug’ilgan kuningiz qaysi oyda?',
            },
            {
              term: '1日 (ついたち)',
              reading: 'ついたち',
              meaning: '1-kun (oyning 1-sanasi)',
              exampleSentence: '5月[ごがつ] 1日[ついたち]は メーデーです。',
              exampleTranslation: '1-may Mehnatkashlar kuni.',
            },
            {
              term: '2日 (ふつか)',
              reading: 'ふつか',
              meaning: '2-kun / 2 kun',
              exampleSentence: '2日[ふつか]に 東京[とうきょう]へ 行[い]きます。',
              exampleTranslation: '2-kuni Tokioga boraman.',
            },
            {
              term: '3日 (みっか)',
              reading: 'みっか',
              meaning: '3-kun / 3 kun',
              exampleSentence: '3日[みっか]に 友達[ともだち]に 会[あ]います。',
              exampleTranslation: "3-kuni do'stim bilan uchrashaman.",
            },
            {
              term: '4日 (よっか)',
              reading: 'よっか',
              meaning: '4-kun / 4 kun',
              exampleSentence: '4日[よっか]は 休[やす]みです。',
              exampleTranslation: '4-kun dam olish kuni.',
            },
            {
              term: '5日 (いつか)',
              reading: 'いつか',
              meaning: '5-kun / 5 kun',
              exampleSentence: '5月[ごがつ] 5日[いつか]は こどもの日[ひ]です。',
              exampleTranslation: '5-may Bolalar kuni.',
            },
            {
              term: '6日 (むいか)',
              reading: 'むいか',
              meaning: '6-kun / 6 kun',
              exampleSentence: '6日[むいか]に 国[くに]へ 帰[かえ]ります。',
              exampleTranslation: '6-kuni yurtimga qaytaman.',
            },
            {
              term: '7日 (なのか)',
              reading: 'なのか',
              meaning: '7-kun / 7 kun',
              exampleSentence: '7月[しちがつ] 7日[なのか]は 七夕[たなばた]です。',
              exampleTranslation: '7-iyul Tanabata festivali.',
            },
            {
              term: '8日 (ようか)',
              reading: 'ようか',
              meaning: '8-kun / 8 kun',
              exampleSentence: '8日[ようか]に 会議[かいぎ]が あります。',
              exampleTranslation: '8-kuni majlis bor.',
            },
            {
              term: '9日 (ここのか)',
              reading: 'ここのか',
              meaning: '9-kun / 9 kun',
              exampleSentence: '9日[ここのか]に 買[か]い物[もの]へ 行[い]きます。',
              exampleTranslation: '9-kuni xaridga boraman.',
            },
            {
              term: '10日 (とおか)',
              reading: 'とおか',
              meaning: '10-kun / 10 kun',
              exampleSentence: '10日[とおか]に 給料[きゅうりょう]を もらいます。',
              exampleTranslation: '10-kuni maosh olaman.',
            },
            {
              term: '14日 (じゅうよっか)',
              reading: 'じゅうよっか',
              meaning: '14-kun / 14 kun',
              exampleSentence: '2月[にがつ] 14日[じゅうよっか]は バレンタインデーです。',
              exampleTranslation: '14-fevral Sevishganlar kuni.',
            },
            {
              term: '20日 (はつか)',
              reading: 'はつか',
              meaning: '20-kun / 20 kun',
              exampleSentence: '20日[はつか]に 日本[にほん]へ 来[き]ました。',
              exampleTranslation: '20-kuni Yaponiyaga keldim.',
            },
            {
              term: '24日 (にじゅうよっか)',
              reading: 'にじゅうよっか',
              meaning: '24-kun / 24 kun',
              exampleSentence: '12月[じゅうにがつ] 24日[にじゅうよっか]は クリスマスイブです。',
              exampleTranslation: '24-dekabr Rojdestvo arafasi.',
            },
            {
              term: '～日 (～にち)',
              reading: '～にち',
              meaning: '~kun / ~sana',
              exampleSentence: '今日[きょう]は 15日[じゅうごにち]です。',
              exampleTranslation: 'Bugun 15-sana.',
            },
            {
              term: '何日 (なんにち)',
              reading: 'なんにち',
              meaning: 'nechanchi sana; necha kun',
              exampleSentence: '今日[きょう]は 何日[なんにち]ですか。',
              exampleTranslation: 'Bugun nechanchi sana?',
            },
            {
              term: 'いつ',
              reading: 'いつ',
              meaning: 'qachon',
              exampleSentence: 'いつ 日本[にほん]へ 来[き]ましたか。',
              exampleTranslation: 'Qachon Yaponiyaga keldingiz?',
            },
            {
              term: '誕生日 (たんじょうび)',
              reading: 'たんじょうび',
              meaning: 'tug’ilgan kun',
              exampleSentence: 'お誕生日[たんじょうび] おめでとう ございます。',
              exampleTranslation: 'Tug’ilgan kuningiz bilan tabriklayman!',
            },
            {
              term: '普通 (ふつう)',
              reading: 'ふつう',
              meaning: 'oddiy (har bekatda to’xtaydigan poyezd)',
              exampleSentence: '普通[ふつう]電車[でんしゃ]に 乗[の]ります。',
              exampleTranslation: 'Oddiy poyezdga minaman.',
            },
            {
              term: '急行 (きゅうこう)',
              reading: 'きゅうこう',
              meaning: 'ekspress (tezkor poyezd)',
              exampleSentence: '急行[きゅうこう]は 速[はや]いです。',
              exampleTranslation: 'Ekspress poyezd tez yurar.',
            },
            {
              term: '特急 (とっきゅう)',
              reading: 'とっきゅう',
              meaning: 'maxsus tezkor poyezd',
              exampleSentence: '特急[とっきゅう]で 名古屋[なごや]へ 行[い]きます。',
              exampleTranslation: 'Maxsus tezyurar poyezdda Nagoyaga boraman.',
            },
            {
              term: '次の (つぎの)',
              reading: 'つぎの',
              meaning: 'keyingi',
              exampleSentence: '次[つぎ]の 電車[でんしゃ]は 9時[くじ]です。',
              exampleTranslation: 'Keyingi poyezd soat 9 da.',
            },
            {
              term: 'どういたしまして。',
              reading: 'どういたしまして。',
              meaning: 'Arzimaydi. / Marhamat.',
              exampleSentence: '「ありがとう ございます。」「どういたしまして。」',
              exampleTranslation: '«Rahmat.» «Arzimaydi.»',
            },
            {
              term: '～番線 (～ばんせん)',
              reading: '～ばんせん',
              meaning: '~yo’l, ~platforma',
              exampleSentence: '東京[とうきょう]行[ゆ]きは 3番線[さんばんせん]です。',
              exampleTranslation: 'Tokio poyezdi 3-platformadan jo’naydi.',
            },
            {
              term: '博多 (はかた)',
              reading: 'はかた',
              meaning: 'Hakata (Fukuokadagi mashhur bekat va shahar)',
              exampleSentence: '博多[はかた]まで 新幹線[しんかんせん]で 行[い]きます。',
              exampleTranslation: 'Hakatagacha shinkansenda boraman.',
            },
            {
              term: '伏見 (ふしみ)',
              reading: 'ふしみ',
              meaning: 'Fushimi (Kiotodagi mashhur ibodatxona va tuman)',
              exampleSentence: '京都[きょうと]の 伏見[ふしみ]へ 行[い]きました。',
              exampleTranslation: 'Kiotodagi Fushimiga bordim.',
            },
            {
              term: '甲子園 (こうしえん)',
              reading: 'こうしえん',
              meaning: 'Koshien (Hyogodagi mashhur beysbol stadioni)',
              exampleSentence: '甲子園[こうしえん]で 野球[やきゅう]を 見[み]ます。',
              exampleTranslation: 'Koshienda beysbol tomosha qilaman.',
            },
            {
              term: '大阪城 (おおさかじょう)',
              reading: 'おおさかじょう',
              meaning: 'Osaka qal’asi',
              exampleSentence: '大阪城[おおさかじょう]は とても 有名[ゆうめい]です。',
              exampleTranslation: 'Osaka qal’asi juda mashhurdir.',
            },
          ],
          grammarRules: [
            {
              pattern: 'OT (joy) へ 行きます／来ます／帰ります',
              meaning:
                "Boriladigan manzil yoki harakat yo'nalishini ko'rsatishda otdan so'ng 「へ (e deb talaffuz qilinadi)」 zarrachasi qo'yiladi. 行きます (bormoq), 来ます (kelmoq), 帰ります (qaytmoq) fe'llari bilan ishlatiladi.",
              usageNotes:
                'Minna no Nihongo 5-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '京都[きょうと]へ 行[い]きます。',
                  translation: 'Kiotoga boraman.',
                },
                {
                  sentence: '日本[にほん]へ 来[き]ました。',
                  translation: 'Yaponiyaga keldim.',
                },
                {
                  sentence: 'うちへ 帰[かえ]ります。',
                  translation: 'Uyga qaytaman.',
                },
              ],
            },
            {
              ...
              meaning:
                "So'roq olmoshidan keyin 「も」 qo'yilsa, barcha variantlar butunlay inkor qilinadi. 「どこへも 行きません」 yoki 「どこも 行きません」 shaklida 'hech qayerga bormayman' degan ma'noni beradi.",
              usageNotes:
                'Minna no Nihongo 5-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '日曜日[にちようび]は どこへも 行[い]きませんでした。',
                  translation: 'Yakshanba kuni hech qayerga bormadim.',
                },
              ],
            },
            {
              pattern: 'OT (transport vositasi) で 行きます／来ます／帰ります',
              meaning:
                "Harakatlanish usuli yoki transport vositasidan keyin 「で」 zarrachasi qo'yiladi (電車で = poyezdda, バスで = avtobusda). ⚠️ ISTISNO: Piyoda borgan hollarda 「歩いて (あるいて)」 ishlatilib, unga 「で」 qo'shilmaydi (xato: 歩いてで).",
              usageNotes:
                'Minna no Nihongo 5-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '電車[でんしゃ]で 行[い]きます。',
                  translation: 'Elektr poyezdda boraman.',
                },
                {
                  sentence: '駅[えき]から 歩[ある]いて 帰[かえ]りました。',
                  translation: 'Bekatdan piyoda qaytdim.',
                },
              ],
            },
            {
              pattern: 'OT (jonli) と FE’L / 一人で',
              meaning:
                "Inson yoki hayvon bilan birgalikda harakat sodir etilganda 「と」 (bilan) zarrachasi qo'yiladi (友達と = do'stim bilan). Agar yolg'iz, bir o'zi harakat qilsa, 「一人で (ひとりで)」 qo'llanadi va unda と qo'yilmaydi.",
              usageNotes:
                'Minna no Nihongo 5-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: '家族[かぞく]と 日本[にほん]へ 来[き]ました。',
                  translation: 'Oilam bilan Yaponiyaga keldim.',
                },
                {
                  sentence: '一人[ひとり]で 東京[とうきょう]へ 行[い]きます。',
                  translation: "Bir o'zim Tokioga boraman.",
                },
              ],
            },
            {
              pattern: 'いつ (Qachon?)',
              meaning:
                "Vaqtni aniqlaydigan umumiy so'roq so'zi 「いつ」 hisoblanadi. Undan keyin 「に」 zarrachasi qo'yilmaydi.",
              usageNotes:
                'Minna no Nihongo 5-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence:
                    'いつ 日本[にほん]へ 来[き]ましたか。… 3月[さんがつ] 25日[にじゅうごにち]に 来[き]ました。',
                  translation: 'Qachon Yaponiyaga keldingiz? … 25-martda keldim.',
                },
              ],
            },
            {
              pattern: 'GAP よ',
              meaning:
                "Gap oxiridagi 「よ」 yuklamasi suhbatdosh bilmagan ma'lumotni yetkazish, xabardor qilish yoki ta'kidlash uchun qo'llanadi ('-ku', 'axir', 'bilib qo'ying').",
              usageNotes:
                'Minna no Nihongo 5-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'この 電車[でんしゃ]は 甲子園[こうしえん]へ 行[い]きませんよ。',
                  translation: 'Bu poyezd Koshienga bormaydi-ku!',
                },
                {
                  sentence: '甲子園[こうしえん]行[ゆ]きは 5番線[ごばんせん]ですよ。',
                  translation: 'Koshien poyezdi 5-yo’ldan jo’naydi-ku!',
                },
              ],
            },
            {
              pattern: 'Sanalar: 〜月 (〜がつ) va 〜日 (〜にち)',
              meaning:
                'Yapon tilida sanalar oy va kun tartibida aytiladi. Oylar: 1月[いちがつ] ... 12月[じゅうにがつ]. Kunlar: 1日 (ついたち), 2日 (ふつか), 3日 (みっか), 4日 (よっか), 5日 (いつか), 6日 (むいか), 7日 (なのか), 8日 (ようか), 9日 (ここのか), 10日 (とおか), 14日 (じゅうよっか), 20日 (はつか), 24日 (にじゅうよっか).',
              usageNotes:
                'Minna no Nihongo 5-dars muhim qoidasi. JLPT N5 grammatika savollarida muntazam uchraydi.',
              examples: [
                {
                  sentence: 'わたしの 誕生[たんじょう]日[び]は 6月[ろくがつ] 10日[とおか]です。',
                  translation: 'Mening tug’ilgan kunim 10-iyunda.',
                },
              ],
            },
          ],
          culturalNotes:
            "Yaponiyada poyezdlar tarmog'i juda taraqqiy etgan (Shinkansen, Tokkyu, Kyuko, Futsu). Bekatlarda adashmaslik uchun platforma raqami (〜番線) va qaysi poyezd tezroq borishini ko'rsatuvchi elektron tablolarga qaraladi.",
        },
      },
      {
        id: 'ja-minna-l5-s2',
