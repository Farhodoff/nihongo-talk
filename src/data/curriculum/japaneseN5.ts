...
export const JAPANESE_N5_LESSONS: Lesson[] = [
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            'Yapon tili fonetikasining asosi 5 ta asosiy unli tovushdan iborat: A, I, U, E, O.',
          keyPoints: [
            'あ (a) — ochiq "a" tovushi',
            'い (i) — "i" tovushi',
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「先生[せんせい]、おはようございます。」",
              options: ['食事[しょくじ]', '運転[うんてん]', '散歩[さんぽ]', 'おはようございます'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"おはようございます\" (Xayrli tong).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Rahmat', 'Xush kelibsiz', 'Xayrli tun', 'Kechirasiz'],
            ...
            },
            {
              ...
              options: ['さようなら', 'おはよう', 'こんばんは (Konbanwa)', 'いただきます'],
              correctAnswerIndex: 2,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Katakana chet el nomlari, xorijiy so'zlar va texnologik atamalarni yozish uchun xizmat qiladi.",
          vocabulary: [
            {
              term: 'コーヒー',
              reading: 'Koohii',
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「朝[あさ]ごはんに パンを 食[た]べます。」",
              options: ['パン', '散歩[さんぽ]', '食事[しょくじ]', '運転[うんてん]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"パン\" (Non (portugalcha pão)).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Radio', 'Televizor', 'Telefon', 'Kompyuter'],
            ...
            },
            {
              ...
              options: ['Magazin', 'Maktab', 'Kutubxona', 'Restoran'],
              correctAnswerIndex: 3,
    ...
    steps: [
      {
        ...
        learnData: {
          title: 'A は B です',
          explanation:
            'AはBです = A bu B dir. Inkor shakli: AはBではありません (yoki じゃありません) = A bu B emasdir.',
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「彼[かれ]は 学生[がくせい]です。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '学生[がくせい]', '食事[しょくじ]'],
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"学生[がくせい]\" (Talaba / O'quvchi).",
            },
          ],
        },
      },
    ...
    steps: [
      {
        ...
        learnData: {
          title: 'これ, それ, あれ, どれ',
          explanation:
            'これ (kore) — gapiruvchiga yaqin ("bu"). それ (sore) — tinglovchiga yaqin ("u"). あれ (are) — ikkalasidan ham uzoqda ("ana u"). どれ (dore) — so\'roq ("qaysi biri?").',
          keyPoints: [
          ...
          exercises: [
            {
              ...
              options: ['それ (Sore)', 'どれ (Dore)', 'あれ (Are)', 'これ (Kore)'],
              correctAnswer: 2,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「これ は 傘[かさ]です。」",
              options: ['傘[かさ]', '食事[しょくじ]', '運転[うんてん]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"傘[かさ]\" (Soyabon).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              ...
              options: ['あれ (Are)', 'どれ (Dore)', 'これ (Kore)', 'それ (Sore)'],
              correctAnswerIndex: 2,
            ...
            },
            {
              ...
              options: ['Bu nima?', 'Kim u?', 'Ana u nima?', 'U qayerda?'],
              correctAnswerIndex: 2,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "AのB = A ning B si. Shuningdek, qaysi sohaga tegishli ekanini bildiradi (e.g. 日本語[にほんご]の 先生[せんせい] = Yapon tili o'qituvchisi).",
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「父[ちち]の 車[くるま]。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '車[くるま]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"車[くるま]\" (Mashina).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Kimning soyaboni?', 'Bu nima?', 'Soyabon qayerda?', 'Qancha turadi?'],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Joylashuv: ここ (bu yer), そこ (u yer), あそこ (ana u yer), どこ (qayer?). Harakat yo'nalishi: へ (e deb o'qiladi): 日本[にほん]へ 行[い]きます (Yaponiyaga boraman).",
          vocabulary: [
            {
              term: '学校[がっこう]',
              reading: 'Gakkou',
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「駅[えき]は どこですか。」",
              options: ['食事[しょくじ]', '運転[うんてん]', '駅[えき]', '散歩[さんぽ]'],
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"駅[えき]\" (Vokzal / Stansiya).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Ishga boraman', 'Maktabga boraman', 'Uyga qaytaman', 'Restoranga kiraman'],
              correctAnswerIndex: 2,
            ...
            },
            {
              ...
              options: ['ここ (Koko)', 'あそこ (Asoko)', 'どこ (Doko)', 'そこ (Soko)'],
              correctAnswerIndex: 1,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Qaysi transportda borishni bildirish uchun で (de) yuklamasi qo'yiladi: 電車[でんしゃ]で 行[い]きます (Poyezdda boraman). Piyoda borsa: 歩[ある]いて 行[い]きます (de ishlatilmaydi).",
          vocabulary: [
            {
              term: '電車[でんしゃ]',
              reading: 'Densha',
          ...
          exercises: [
            {
              ...
              type: 'multiple-choice',
              prompt:
                '「バス_______ 会社[かいしゃ]へ 行[い]きます。」 (Avtobusda kompaniyaga boraman)',
              options: ['に (ni)', 'で (de)', 'へ (e)', 'を (o)'],
              correctAnswer: 1,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「飛行機[ひこうき]で 来[き]ました。」",
              options: ['散歩[さんぽ]', '飛行機[ひこうき]', '運転[うんてん]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"飛行機[ひこうき]\" (Samolyot).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Qaytmoq', 'Yemoq', 'Kelmoq', 'Ketmoq / Bormoq'],
              correctAnswerIndex: 2,
            ...
            },
            {
              ...
              options: ['で (de)', 'へ (e)', 'を (o)', 'と (to) — 誰[だれ]と'],
              correctAnswerIndex: 3,
            ...
            },
            {
              ...
              options: ["Bir o'zi / Yolg'iz", 'Oilasi bilan', "Do'sti bilan", 'Poyezdda'],
              correctAnswerIndex: 0,
  ...
  },
  {
    ...
    description:
      "To'ldiruvchi yuklamasi (を - o) va asosiy o'timli fe'llar (yemoq, ichmoq, ko'rmoq).",
    estimatedDurationMinutes: 14,
    icon: '🍱',
    steps: [
      {
        ...
        learnData: {
          title: "Ot + を + Fe'l",
          explanation:
            "Ish-harakat qaysi narsaga qaratilgan bo'lsa, unga を (o) yuklamasi qo'shiladi.",
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「お茶[ちゃ]を 飲[の]みます。」",
              options: ['飲[の]みます', '食事[しょくじ]', '散歩[さんぽ]', '運転[うんてん]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"飲[の]みます\" (Ichmoq).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Xat yozaman', 'Rasm chizaman', "Xat o'qiyman", "Kitob o'qiyman"],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "1. Agar joyda biror faol harakat qilinsa (o'qimoq, ovqatlanmoq, ishlamoq) -> で (de) ishlatiladi: 図書館[としょかん]で 勉強[べんきょう]します. 2. Agar shunchaki biror narsa yoki inson mavjud bo'lsa (arimasu / imasu) -> に (ni) ishlatiladi: 部屋[へや]に 机[つくえ]が あります.",
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「友達[ともだち]と 図書館[としょかん]へ 行[い]きます。」",
              options: ['散歩[さんぽ]', '食事[しょくじ]', '運転[うんてん]', '友達[ともだち]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"友達[ともだち]\" (Doʻst).",
            },
          ],
        },
      },
    ...
    steps: [
      {
        ...
        learnData: {
          title: '〜ませんか & 〜ましょう',
          explanation:
            '1. 〜ませんか (masen ka) — Muloyim taklif ("Birga ... qilmaymizmi?"). 2. 〜ましょう (mashou) — Qat\'iy taklif / Rozi bo\'lish ("Qani, qilaylik!").',
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「毎日[まいにち] 朝[あさ]６時[ろくじ]に 起[お]きます。」",
              options: ['毎日[まいにち]', '運転[うんてん]', '食事[しょくじ]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"毎日[まいにち]\" (Har kuni).",
            },
          ],
        },
      },
    ...
    steps: [
      {
        ...
        learnData: {
          title: '〜時 (Ji) & 〜曜日 (Youbi)',
          explanation:
            'Soat: 1時 (ichiji), 2時 (niji), 4時 (yoji - istisno), 9時 (kuji - istisno). Hafta kunlari: 月曜日 (Dushanba), 火曜日 (Seshanba), 水曜日 (Chorshanba), 木曜日 (Payshanba), 金曜日 (Juma), 土曜日 (Shanba), 日曜日 (Yakshanba).',
          vocabulary: [
            {
              term: '何時[なんじ]',
              reading: 'Nanji',
          ...
          exercises: [
            {
              ...
              options: ['よんじ (Yonji)', 'よっじ (Yojji)', 'よじ (Yoji)', 'しじ (Shiji)'],
              correctAnswer: 2,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「日曜日[にちようび]は 休[やす]みです。」",
              options: ['散歩[さんぽ]', '日曜日[にちようび]', '運転[うんてん]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"日曜日[にちようび]\" (Yakshanba).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['くじ (Kuji)', 'きゅうじかん', 'きゅうじ (Kyuuji)', 'くにん'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['Besh daqiqa', 'Aniq soat', 'Chorak kam', 'Yarim (masalan 7時半 = 7:30)'],
              correctAnswerIndex: 3,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "100 = 百 (hyaku), 1,000 = 千 (sen), 10,000 = 一万 (ichiman). Yaponiyada hisoblash 4 ta nolli xonalar bilan bo'linadi (Man = 10,000). Narx so'rash: これは いくらですか (Bu qancha turadi?).",
          vocabulary: [
            {
              term: 'いくら',
              reading: 'Ikura',
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「百円[ひゃくえん]です。」",
              options: ['円[えん]', '運転[うんてん]', '食事[しょくじ]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"円[えん]\" (Iyena (Yaponiya pul birligi)).",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      'Sanoq suffikslari: odamlar (nin), kitoblar (satsu), uzun buyumlar (hon), yupqa narsalar (mai), umumiy donalar (tsu).',
    estimatedDurationMinutes: 14,
    icon: '🔢',
    steps: [
      {
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「二人[ふたり]で 食[た]べます。」",
              options: ['運転[うんてん]', '二人[ふたり]', '散歩[さんぽ]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"二人[ふたり]\" (Ikki kishi).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              id: 'ja-n5-u3-l3-q1',
              question:
                "Qog'oz yoki chipta kabi yupqa narsalar uchun qaysi sanoq qo'shimchasi ishlatiladi?",
              options: ['本 (hon)', '人 (nin)', '冊 (satsu)', '枚 (mai)'],
              correctAnswerIndex: 3,
            ...
            },
            {
              ...
              options: ['階 (kai)', '本 (hon)', '枚 (mai)', '冊 (satsu)'],
              correctAnswerIndex: 1,
    ...
    steps: [
      {
        ...
        learnData: {
          title: '〜ました & 〜ませんでした',
          explanation:
            "Hozirgi zamon: 食べます (yeyman) / 食べません (yemayman). O'tgan zamon: 食べました (yedim) / 食べませんでした (yemadim).",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              options: ['見[み]ませんでした', '見[み]ます', '見[み]ました (Mimashita)', '見[み]る'],
              correctAnswer: 2,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「先週[せんしゅう] 日本[にほん]へ 来[き]ました。」",
              options: ['食事[しょくじ]', '散歩[さんぽ]', '先週[せんしゅう]', '運転[うんてん]'],
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"先週[せんしゅう]\" (O'tgan hafta).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Sotib olmadim', 'Sotib oling', 'Sotib olaman', 'Sotib oldim'],
              correctAnswerIndex: 3,
            ...
            },
            {
              ...
              options: ['先月[せんげつ]', '毎月[まいつき]', '来月[らいげつ]', '今月[こんげつ]'],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            'A: すみません、郵便局[ゆうびんきょく]は どこですか。 B: あそこに 銀行[ぎんこう]が ありますね。郵便局[ゆうびんきょく]は 銀行[ぎんこう]の 隣[となり]です。 A: どうも ありがとうございます。',
          keyPoints: [
          ...
          grammarRules: [
            {
              ...
              meaning:
                "Vokzalda va ko'chada yo'l so'rash, xarid qilish dialoglarini tinglab tushunish.",
              usageNotes:
                'A: すみません、郵便局[ゆうびんきょく]は どこですか。 B: あそこに 銀行[ぎんこう]が ありますね。郵便局[ゆうびんきょく]は 銀行[ぎんこう]の 隣[となり]です。 A: どうも ありがとうございます。',
              examples: [
                {
          ...
          exercises: [
            {
              ...
              options: ['Park orqasida', 'Bankning yonida', 'Maktab ichida', 'Vokzal qarshisida'],
              correctAnswer: 1,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「銀行[ぎんこう]の 隣[となり]。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '銀行[ぎんこう]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"銀行[ぎんこう]\" (Bank).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              ...
              options: ['ごちそうさま', 'すみません (Sumimasen)', 'さようなら', 'いただきます'],
              correctAnswerIndex: 1,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "い sifatlar oxiri \"i\" bilan tugaydi (masalan: 高い - takai). Turlanishi: 1. Hozirgi tasdiq: 高いです (Qimmat). 2. Hozirgi inkor: 高くないです (Qimmat emas - i tushib kunai bo'ladi). 3. O'tgan tasdiq: 高かったです (Qimmat edi - katta). 4. O'tgan inkor: 高くなかったです (Qimmat emas edi - kunakatta). Istisno: いい (yaxshi) -> よくない / よかった / よくなかった.",
          vocabulary: [
            {
              term: '高[たか]い',
              reading: 'Takai',
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「この店[みせ]は 安[やす]いです。」",
              options: ['安[やす]い', '散歩[さんぽ]', '食事[しょくじ]', '運転[うんてん]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"安[やす]い\" (Arzon).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ["Sho'r", 'Qimmat', 'Mazali / Shiringina', 'Achchiq'],
              correctAnswerIndex: 2,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Ot oldidan kelganda な (na) qo'shiladi: きれいな花[はな] (chiroyli gul), 静[しず]かな町[まち] (tinch shahar). Gap oxirida です bilan keladi: この町[まち]は 静[しず]かです. Inkor: 静[しず]かではありません.",
          vocabulary: [
            {
              term: '有名[ゆうめい]な',
              reading: 'Yuumei na',
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「田中[たなか]さんは 親切[しんせつ]です。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '親切[しんせつ]な', '食事[しょくじ]'],
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"親切[しんせつ]な\" (Mehribon / Ochiqko'ngil).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Qulay', 'Issiq', 'Shovqinli', 'Tinch / Sokin'],
              correctAnswerIndex: 3,
  ...
  },
  {
    ...
    description:
      "Jonsiz narsalar/o'simliklar (arimasu) va tirik jonivorlar/insonlar (imasu) mavjudligi.",
    estimatedDurationMinutes: 14,
    icon: '🐱',
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "1. Jonsiz buyumlar, kitob, stol, daraxt uchun -> あります (arimasu). 2. Insonlar, hayvonlar, baliq, qushlar uchun -> います (imasu). Egaga が (ga) yuklamasi qo'yiladi.",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              options: ['です', 'します', 'います (Imasu)', 'あります (Arimasu)'],
              correctAnswer: 2,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「猫[ねこ]が 好[す]きです。」",
              options: ['猫[ねこ]', '食事[しょくじ]', '運転[うんてん]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"猫[ねこ]\" (Mushuk).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Ayol kishi bor', 'Bola bor', "Hech kim yo'q", 'Erkak kishi bor'],
              correctAnswerIndex: 3,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "1. Biror buyumni xohlash: Ot + が + ほしいです (Masalan: 新[あたら]しい 車[くるま]が ほしいです). 2. Biror ishni qilishni xohlash: Fe'lning Masu asosi + たいです (Masalan: 日本[にほん]へ 行[い]きたいです - bormoqchiman).",
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「時間[じかん]は とても 大切[たいせつ]です。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '大切[たいせつ]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"大切[たいせつ]\" (Muhim, qadrli).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              id: 'ja-n5-u4-l4-q4',
              question:
                "Boshqa birovning xohishini to'g'ridan-to'g'ri «〜たいですか» deb so'rash odobdanmi?",
              options: [
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '田中[たなか]さんは 毎朝[まいあさ] 7時[しちじ]に 起[お]きます。朝[あさ]ごはんは パンと 卵[たまご]を 食[た]べます。それから 8時[はちじ]に 電車[でんしゃ]で 会社[かいしゃ]へ 行[い]きます。会社[かいしゃ]は 9時[くじ]から 5時[ごじ]までです。夜[よる]は 家[うち]で 日本語[にほんご]を 勉強[べんきょう]します。',
          keyPoints: [
          ...
          exercises: [
            {
              ...
              options: ['8時[はちじ]', '7時[しちじ]', '9時[くじ]', '5時[ごじ]'],
              correctAnswer: 0,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「日本語[にほんご]を 勉強[べんきょう]します。」",
              options: [
                '食事[しょくじ]',
                '散歩[さんぽ]',
                '勉強[べんきょう]します',
              ...
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"勉強[べんきょう]します\" (Oʻrganmoq, dars qilmoq).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Avtobusda (バス)', 'Poyezdda (電車)', 'Piyoda (歩いて)', 'Mashinada (車)'],
              correctAnswerIndex: 1,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '一 (ichi - bir), 二 (ni - ikki), 三 (san - uch), 日 (hi/nichi - quyosh/kun), 月 (tsuki/getsu - oy), 木 (ki/moku - daraxt), 水 (mizu/sui - suv), 火 (hi/ka - olov).',
          vocabulary: [
            {
              term: '日本[にほん]',
              reading: 'Nihon',
          ...
          exercises: [
            {
              ...
              options: ['Suv (Mizu)', 'Oy (Tsuki)', 'Daraxt (Ki)', 'Olov (Hi)'],
              correctAnswer: 2,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「水曜日[すいようび]に 会[あ]いましょう。」",
              options: ['散歩[さんぽ]', '水曜日[すいようび]', '運転[うんてん]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"水曜日[すいようび]\" (Chorshanba (Suv kuni)).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Seshanba (Olov kuni)', 'Juma', 'Chorshanba', 'Dushanba'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['Daraxt', 'Oltin', 'Quyosh', 'Oy va dushanba (Getsuyoubi)'],
              correctAnswerIndex: 3,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "人 (hito/jin - inson), 男 (otoko - erkak), 女 (onna - ayol), 大 (dai/oo - katta), 小 (shou/chii - kichik), 中 (chuu/naka - ichi/o'rtasi), 上 (ue - tepa/usti), 下 (shita - pasti/tagi).",
          vocabulary: [
            {
              term: '大人[おとな]',
              reading: 'Otona',
          ...
          grammarRules: [
            {
              pattern:
                'N5 Basic Kanji 2: People, Directions & Sizes (人, 男, 女, 大, 小, 中, 上, 下)',
          ...
          exercises: [
            {
              ...
              options: ['上 (ue)', '下 (shita)', '中 (naka)', '前 (mae)'],
              correctAnswer: 0,
              explanation: '上 — Usti.',
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「大学[だいがく]で 学[まな]びます。」",
              options: ['大学[だいがく]', '食事[しょくじ]', '散歩[さんぽ]', '運転[うんてん]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"大学[だいがく]\" (Universitet (Katta ta'lim)).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              ...
              options: ["O'g'il bola", 'Qiz bola', 'Katta yoshli kishi', "O'qituvchi"],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['Kechasi', 'Yarim kun', "Kun bo'yi / Kun davomida", 'Ertalab'],
              correctAnswerIndex: 2,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "学 (gaku - o'rganish), 校 (kou - maktab), 先 (sen - oldingi), 生 (sei/u - hayot/tug'ilish), 本 (hon/moto - kitob/asos), 車 (kuruma/sha - g'ildirak/mashina), 電 (den - elektr).",
          vocabulary: [
            {
              term: '先生[せんせい]',
              reading: 'Sensei',
          ...
          exercises: [
            {
              ...
              options: ['Shifoxona', 'Poyezd', "O'qituvchi", "Talaba / O'quvchi"],
              correctAnswer: 3,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「電車[でんしゃ]に 乗[の]ります。」",
              options: ['散歩[さんぽ]', '食事[しょくじ]', '運転[うんてん]', '電車[でんしゃ]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"電車[でんしゃ]\" (Poyezd (Elektr mashina)).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              ...
              options: ['先生[せんせい]', '大学[だいがく]', '学生[がくせい]', '学校[がっこう]'],
              correctAnswerIndex: 3,
            ...
            },
            {
              ...
              options: ['Telefon', 'Poyezd', 'Elektr toki / Chiroq', 'Mashina'],
              correctAnswerIndex: 2,
            ...
            },
            {
              ...
              options: ["Tug'ilmoq", 'Yashamoq', 'Yurmoq', "O'qimoq"],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "JLPT N5 uch bo'limdan iborat: 1. Moji/Goi (So'z boyligi va kanji). 2. Bunpou/Dokkai (Grammatika va o'qish). 3. Choukai (Eshitish). Eslatma: JLPT da speaking bo'limi yo'q.",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              type: 'multiple-choice',
              prompt:
                '「私[わたし]は 日曜日[にちようび]_______ 友達[ともだち]と サッカーを しました。」',
              options: ['を (o)', 'へ (e)', 'に (ni)', 'で (de)'],
              correctAnswer: 2,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Siz Xiragana, Katakana, 100 ga yaqin N5 kanjilari, barcha asosiy yuklamalar (wa, ga, o, ni, de, e, to, mo, kara, made), i/na sifatlar va kundalik muloqotni to'liq egalladingiz!",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              type: 'multiple-choice',
              prompt:
                '「すみません、この 傘[かさ]を _______。」 (Kechirasiz, shu soyabonni bering)',
              options: ['します', 'ください (Kudasai)', 'います', 'あります'],
              correctAnswer: 1,
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「友達[ともだち]と 図書館[としょかん]へ 行[い]きます。」",
              options: ['運転[うんてん]', '友達[ともだち]', '散歩[さんぽ]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"友達[ともだち]\" (Doʻst).",
            },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['行[い]きませんでした', '行[い]きます', '行[い]かない', '行[い]きました'],
              correctAnswerIndex: 0,
