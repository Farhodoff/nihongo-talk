          ...
          exercises: [
            {
              ...
              options: ['飲[の]んで (Nonde)', '飲[の]って', '飲[の]いで', '飲[の]みて'],
              correctAnswer: 0,
          ...
          questions: [
            {
              ...
              options: ['行[い]って (Itte)', '行[い]んで', '行[い]ちて', '行[い]いて'],
            ...
            },
            {
              ...
              options: ['食[た]べって', '食[た]べんで', '食[た]べして', '食[た]べて (Tabete)'],
            ...
            },
            {
              ...
              options: ['話[はな]して (Hanashite)', '話[はな]して', '話[はな]んで', '話[はな]って'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['買[か]して', '買[か]って (Katte)', '買[か]いて', '買[か]いで'],
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['こない (Konai)', 'きない', 'くらない', 'かない'],
              correctAnswerIndex: 0,
              explanation: 'Konai.',
            },
            {
            ...
            },
            {
              ...
              options: ['買[か]わない (Kawanai)', '買[か]かない', '買[か]いない', '買[か]あない'],
              correctAnswerIndex: 0,
              explanation: 'Kawanai.',
            },
          ],
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['どれ (Dore)', 'どちら (Dochira)', 'だれ (Dare)', 'どこ (Doko)'],
              correctAnswerIndex: 1,
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['される', 'できる (Dekiru)', 'しられる', 'すれる'],
              correctAnswerIndex: 1,
              explanation: 'Dekiru.',
            },
          ],
          ...
          exercises: [
            {
              ...
              options: ["O'qimoq (Yomu)", "Ko'rmoq", 'Eshitmoq', 'Yozmoq'],
              correctAnswer: 0,
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Eshik', 'Oyna', 'Bino', 'Kitob / Yozuv (Sho)'],
              correctAnswerIndex: 3,
          ...
          exercises: [
            {
              ...
              options: ['高[たか]い', '多[おお]い', '安[やす]い', '古[ふる]い (eski)'],
              correctAnswer: 3,
          ...
          exercises: [
            {
              ...
              options: ['行[い]こう (Ikou)', '行[い]きます', '行[い]よう', '行[い]け'],
              correctAnswer: 0,
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['食[た]べろう', '食[た]べ', '食[た]べよう (Tabeyou)', '食[た]ぼう'],
              correctAnswerIndex: 2,
              explanation: 'Tabeyou.',
            },
            {
              ...
              options: ['せよう', 'しよう (Shiyou)', 'すよう', 'さよう'],
              correctAnswerIndex: 1,
              explanation: 'Shiyou.',
            },
          ],
          ...
          questions: [
            {
              ...
              options: ['もらいました', '貸[か]した', 'くれました (Kuremashita)', 'あげました'],
              correctAnswerIndex: 2,
            ...
            },
            {
              ...
              options: ['いいです', 'ない', 'なります', 'なりません (Narimasen)'],
              correctAnswerIndex: 3,
            ...
            },
            {
              ...
              options: ['できます (Dekimasu)', 'あります', 'します', 'います'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['JLPT N1', 'IELTS 7.0', 'JLPT N3 (Intermediate)', 'A1'],
              correctAnswerIndex: 2,
              explanation: 'JLPT N3.',
            },
          ],
