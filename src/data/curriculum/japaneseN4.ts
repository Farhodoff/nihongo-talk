...
export const JAPANESE_N4_LESSONS: Lesson[] = [
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Yapon tili fe'llari 3 guruhga bo'linadi: Guruh 1 (Godan), Guruh 2 (Ichidan - eru/iru), Guruh 3 (Fukisoku: します, 来ます).",
          keyPoints: [
          ...
          grammarRules: [
            {
              ...
              meaning:
                "Fe'llarning て-shakliga o'tish qoidalari (Guruh 1, Guruh 2 va Guruh 3 fe'llari).",
              usageNotes:
                "Yapon tili fe'llari 3 guruhga bo'linadi: Guruh 1 (Godan), Guruh 2 (Ichidan - eru/iru), Guruh 3 (Fukisoku: します, 来ます).",
              examples: [
                {
          ...
          exercises: [
            {
              ...
              options: ['飲[の]んで', '飲[の]って', '飲[の]いで', '飲[の]みて'],
              correctAnswer: 0,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「名前[なまえ]を 書[か]いてください。」",
              options: ['書[か]きます', '食事[しょくじ]', '運転[うんてん]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"書[か]きます\" (Yozmoq (Te-form: 書[か]いて)).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              ...
              options: ['行[い]って', '行[い]んで', '行[い]ちて', '行[い]いて'],
            ...
            },
            {
              ...
              options: ['食[た]べって', '食[た]べんで', '食[た]べして', '食[た]べて'],
            ...
            },
            {
              ...
              options: ['話[はな]して', '話[はな]して', '話[はな]んで', '話[はな]って'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['買[か]して', '買[か]って', '買[か]いて', '買[か]いで'],
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「この 説明[せつめい]は 少[すこ]し 複雑[ふくざつ]です。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '複雑[ふくざつ]'],
              correctAnswer: 3,
              explanation:
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              id: 'ja-n4-u1-l2-q4',
              question:
                "Rasmiy kishilarga buyruq bermaslik uchun «kudasai» o'rniga yanada muloyimroq qaysi ibora ishlatiladi?",
              options: [
                '〜てくれ',
                '〜ろ',
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '1. Ruxsat: Fe\'lning て-shakli + もいいですか ("... qilsam maylimi?"). 2. Taqiq: Fe\'lning て-shakli + はいけません ("... qilish taqiqlanadi / mumkin emas").',
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「どうぞ 遠慮[えんりょ]しないで ください。」",
              options: ['食事[しょくじ]', '散歩[さんぽ]', '遠慮[えんりょ]します', '運転[うんてん]'],
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"遠慮[えんりょ]します\" (Tortinmoq, rad etmoq).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['見[み]てください', 'いいですよ', 'いけません', '見[み]ませんでした'],
              correctAnswerIndex: 1,
  ...
  },
  {
    ...
    description:
      'Hozir davom etayotgan harakat (shiteru) va natijaviy holat (kekkon shiteru, sunderu).',
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "1. Jarayon (Progressive): 今[いま]、本[ほん]を 読[よ]んでいます (Hozir kitob o'qiyapman). 2. Natijaviy doimiy holat (Resultant State): 結婚[けっこん]しています (Uylangan / Turmushga chiqqan), 住[す]んでいます (Yashaydi), 知[し]っています (Biladi).",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              type: 'multiple-choice',
              prompt:
                "«U kishini taniysizmi?» — «Yo'q, bilmayman (tanimayman)» inkor shakli qaysi?",
              options: [
                'いいえ、知[し]った',
                'いいえ、知[し]る',
                'いいえ、知[し]っていません',
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「その人[ひと]を 知[し]っています。」",
              options: ['運転[うんてん]', '知[し]ります', '散歩[さんぽ]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"知[し]ります\" (Bilib olmoq (Holat: 知[し]っている)).",
            },
          ],
        },
      },
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Birinchi harakat to'liq yakunlangandan so'ng ikkinchi harakat boshlanishini qat'iy bildiradi.",
          keyPoints: [
          ...
          grammarRules: [
            {
              ...
              meaning:
                "Ketma-ket harakatlar: bir ishni qilib bo'lgach (te kara) ikkinchisini qilish.",
              usageNotes:
                "Birinchi harakat to'liq yakunlangandan so'ng ikkinchi harakat boshlanishini qat'iy bildiradi.",
              examples: [
                {
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「試験[しけん]の 準備[じゅんび]を 始[はじ]めましょう。」",
              options: ['準備[じゅんび]', '運転[うんてん]', '食事[しょくじ]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"準備[じゅんび]\" (Tayyorgarlik).",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      'Fe\'llarning oddiy inkor shakli (Nai-form) va "... qilmang, iltimos" (naide kudasai).',
    estimatedDurationMinutes: 14,
    icon: '⛔',
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '1. Guruh 2: ます tushadi + ない (食[た]べない, 見[み]ない). 2. Guruh 3: します -> しない, 来[き]ます -> こない (Konai). 3. Guruh 1: Oxirgi "i" tovushi "a" tovushiga o\'zgaradi: 書[か]きます -> 書[か]かない, 飲[の]みます -> 飲[の]まない. Istisno: 買[か]います -> 買[か]わない (wa bo\'ladi).',
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「傘[かさ]を 忘[わす]れないで ください。」",
              options: ['散歩[さんぽ]', '食事[しょくじ]', '運転[うんてん]', '忘[わす]れます'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"忘[わす]れます\" (Unutmoq).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              ...
              options: ['話[はな]わらい', '話[はな]さない', '話[はな]しない', '話[はな]せない'],
              correctAnswerIndex: 1,
            ...
            },
            {
              ...
              options: ['買[か]わない', '買[か]かない', '買[か]いない', '買[か]あない'],
              correctAnswerIndex: 0,
              explanation: 'Kawanai.',
            },
          ],
  ...
  },
  {
    ...
    description:
      'Hayotiy tajribani ifodalash: "... qilganman / tajribam bor" (Ta-form + koto ga aru).',
    estimatedDurationMinutes: 14,
    icon: '🌟',
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Hayotda hech bo'lmasa bir marta sodir bo'lgan tajribani bildirish: 富士山[ふじさん]に 登[のぼ]ったことが あります (Fudzi tog'iga chiqqanman). Inkor: 一度[いちど]も ありません (Biror marta ham bo'lmagan).",
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「どうぞ 遠慮[えんりょ]しないで ください。」",
              options: ['遠慮[えんりょ]します', '運転[うんてん]', '食事[しょくじ]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"遠慮[えんりょ]します\" (Tortinmoq, rad etmoq).",
            },
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "1. Ikki narsani taqqoslash: Aのほうが Bより Sifat です (A, B dan ko'ra sifatliroqdir). 2. Guruh ichida eng yuqori daraja: [Guruh] の中[なか]で 何[なに]/誰[だれ]が 一番[いちばん] Sifat ですか (Orasida eng ... qaysi?).",
          keyPoints: [
          ...
          grammarRules: [
            {
              ...
              meaning:
                "Taqqoslama (A ga qaraganda B ko'proq...) va orttirma daraja (orasida eng...).",
              usageNotes:
                "1. Ikki narsani taqqoslash: Aのほうが Bより Sifat です (A, B dan ko'ra sifatliroqdir). 2. Guruh ichida eng yuqori daraja: [Guruh] の中[なか]で 何[なに]/誰[だれ]が 一番[いちばん] Sifat ですか (Orasida eng ... qaysi?).",
              examples: [
                {
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「町[まち]を 案内[あんない]して くれました。」",
              options: ['運転[うんてん]', '案内[あんない]します', '散歩[さんぽ]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"案内[あんない]します\" (Yoʻl koʻrsatmoq, tanishtirmoq).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              id: 'ja-n4-u2-l3-q2',
              question:
                "「日本[にほん]と ウズベキスタンと どちらが 広[ひろ]いですか」ning ma'nosi:",
              options: [
  ...
  },
  {
    ...
    description:
      'Majburiyat ("... qilish shart/kerak") va majburiyat yo\'qligi ("... qilmasa ham mayli").',
    estimatedDurationMinutes: 14,
    icon: '⚠️',
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '1. Majburiyat: Fe\'lning ない-shaklidagi "i" tushadi + ければなりません / ければいけません ("... qilish shart"). 2. Majburiy emas: ない-shaklidagi "i" tushadi + くてもいいです ("... qilmasa ham bo\'ladi").',
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「試験[しけん]の 準備[じゅんび]を 始[はじ]めましょう。」",
              options: ['食事[しょくじ]', '散歩[さんぽ]', '準備[じゅんび]', '運転[うんてん]'],
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"準備[じゅんび]\" (Tayyorgarlik).",
            },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['〜ないで', '〜ます', '〜てもいい', '〜なきゃ (Nakya) / 〜なくちゃ'],
              correctAnswerIndex: 3,
            ...
            },
            {
              ...
              options: ["To'lay olmayman", "To'lamasa ham bo'ladi", "To'lash shart", "To'ladim"],
              correctAnswerIndex: 1,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '【中央[ちゅうおう] 図書館[としょかん]の 利用[りよう] 案内[あんない]】 開館[かいかん] 時間[じかん]：午前[ごぜん]9時[くじ]〜午後[ごご]7時[しちじ]（土日[どにち]は午後[ごご]5時[ごじ]まで）。 休館日[きゅうかんび]：毎週[まいしゅう] 月曜日[げつようび]。 本[ほん]は 一人[ひとり] 5冊[ごさつ]まで、2週間[にしゅうかん] 借[か]りることができます。 返却[へんきゃく]が 遅[おく]れた 場合[ばあい]、新[あたら]しい 本[ほん]を 借[か]りることができません。',
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「本[ほん]の 返却[へんきゃく]。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '返却[へんきゃく]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"返却[へんきゃく]\" (Qaytarib berish (kitobni)).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              id: 'ja-n4-u2-l5-q4',
              question:
                "JLPT N4 Dokkai bo'limida bunday ma'lumot qidirish topshirig'i nima deb ataladi?",
              options: ['情報検索[じょうほうけんさく]', 'Insho', 'Tinglash', 'Grammatika'],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '1. Lug\'at shakli + ことができる: 泳[およ]ぐ ことが できます. 2. Qisqa imkoniyat shakli (Kanoukei): Guruh 1 da oxirgi "u" tovushi "e" ga o\'zgaradi: 泳[およ]ぐ -> 泳[およ]げる, 話[はな]す -> 話[はな]せる, 行[い]く -> 行[い]ける. Guruh 2: 食べる -> 食べられる, 見る -> 見られる. Guruh 3: します -> できる, 来る -> こられる.',
          keyPoints: [
          ...
          exercises: [
            {
              ...
              options: ['書[か]けます', '書[か]かれます', '書[か]きます', '書[か]ける'],
              correctAnswer: 0,
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「どうぞ 遠慮[えんりょ]しないで ください。」",
              options: ['遠慮[えんりょ]します', '散歩[さんぽ]', '食事[しょくじ]', '運転[うんてん]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"遠慮[えんりょ]します\" (Tortinmoq, rad etmoq).",
            },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['食[た]べれます', '食[た]べます', '食[た]べれる', '食[た]べられます'],
              correctAnswerIndex: 3,
    ...
    steps: [
      {
        ...
        learnData: {
          title: 'あげる, もらう, くれる',
          explanation:
            '1. あげる (Ageru): Men birovga beraman / A kishi B ga beradi. 2. もらう (Morau): Men birovdan qabul qilib olaman. 3. くれる (Kureru): Birov menga (yoki mening oilamga) beradi.',
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「町[まち]を 案内[あんない]して くれました。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '案内[あんない]します', '食事[しょくじ]'],
              correctAnswer: 2,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"案内[あんない]します\" (Yoʻl koʻrsatmoq, tanishtirmoq).",
            },
          ...
          questions: [
            {
              ...
              options: ['〜て あげました', '〜ないで', '〜て くれました', '〜て ください'],
              correctAnswerIndex: 2,
    ...
    steps: [
      {
        ...
        learnData: {
          title: 'Action Kanjis',
          explanation:
            "行 (i/kou - bormoq), 来 (ki/rai - kelmoq), 帰 (kae/ki - qaytmoq), 買 (ka/bai - sotib olmoq), 見 (mi/ken - ko'rmoq), 聞 (ki/bun - eshitmoq), 書 (ka/sho - yozmoq), 読 (yo/doku - o'qimoq).",
          vocabulary: [
            {
              term: '新聞[しんぶん]',
              reading: 'Shinbun',
          ...
          exercises: [
            {
              ...
              options: ["O'qimoq", "Ko'rmoq", 'Eshitmoq', 'Yozmoq'],
              correctAnswer: 0,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「旅行[りょこう]に 行[い]きます。」",
              options: ['旅行[りょこう]', '食事[しょくじ]', '運転[うんてん]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"旅行[りょこう]\" (Sayohat).",
            },
          ],
        },
      },
          ...
          questions: [
            {
              ...
              options: ['来年[らいねん]', '去年[きょねん]', '毎年[まいとし]', '今年[ことし]'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['Eshik', 'Oyna', 'Bino', 'Kitob / Yozuv'],
              correctAnswerIndex: 3,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "社 (sha - jamiyat/kompaniya), 会 (kai/a - uchrashuv), 駅 (eki - stansiya), 店 (mise/ten - do'kon). Juftliklar: 多 (ooi - ko'p) <-> 少 (sukunai - oz); 高 (takai - baland/qimmat) <-> 安 (yasui - arzon/osuda); 新 (atarashii - yangi) <-> 古 (furui - eski).",
          vocabulary: [
            {
              term: '会社[かいしゃ]',
              reading: 'Kaisha',
          ...
          grammarRules: [
            {
              pattern:
                'N4 Kanji 2: Society, Time & Opposites (社, 会, 駅, 店, 多, 少, 高, 安, 新, 古)',
          ...
          exercises: [
            {
              ...
              options: ['高[たか]い', '多[おお]い', '安[やす]い', '古[ふる]い'],
              correctAnswer: 3,
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「安全[あんぜん]な 町[まち]。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '安全[あんぜん]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"安全[あんぜん]\" (Xavfsiz).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Vokzal qarshisi / Vokzal oldi maydoni', 'Vokzal ichi', 'Poyezd', 'Chipta'],
              correctAnswerIndex: 0,
  ...
  },
  {
    ...
    description:
      'Poyezdlarni almashtirish (norikae) va jamoat transporti eshittirishlarini tushunish.',
    estimatedDurationMinutes: 15,
    icon: '🚆',
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "E'lon:「次[つぎ]は 新宿[しんじゅく]、新宿[しんじゅく]です。中央線[ちゅうおうせん]は お乗[の]り換[か]えです。お降[お]りの 際[さい]は、足元[あしもと]に ご注意[ちゅうい]ください。」",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Chuuou liniyasiga chiqmoqchi bo'lgan yo'lovchi qaysi bekatda tushishi kerak?",
              options: ['Shibuya bekatida', 'Tokio bekatida', 'Shinjuku bekatida', 'Ueno bekatida'],
              correctAnswer: 2,
          ...
          questions: [
            {
              ...
              options: ['後[うし]ろは', '前[まえ]は', '次[つぎ]は ...', '終[お]わりは'],
              correctAnswerIndex: 2,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "1. Fe'lning oddiy shakli + つもりです (shaxsiy qat'iy niyat): 国[くに]へ 帰[かえ]る つもりです (Vatanimga qaytish niyatidaman). 2. Fe'lning oddiy shakli / Ot + の + 予定[よてい]です (jadval asosidagi rasmiy reja): 来週[らいしゅう] 出張[しゅっちょう]の 予定[よてい]です.",
          vocabulary: [
            {
              term: '予定[よてい]',
              reading: 'Yotei',
          ...
          grammarRules: [
            {
              ...
              meaning:
                'Rejalar va qat\'iy niyatlar ("... qilish niyatidaman / rejalashtirganman").',
              usageNotes:
                "1. Fe'lning oddiy shakli + つもりです (shaxsiy qat'iy niyat): 国[くに]へ 帰[かえ]る つもりです (Vatanimga qaytish niyatidaman). 2. Fe'lning oddiy shakli / Ot + の + 予定[よてい]です (jadval asosidagi rasmiy reja): 来週[らいしゅう] 出張[しゅっちょう]の 予定[よてい]です.",
              examples: [
                {
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「大阪[おおさか]へ 出張[しゅっちょう]します。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '出張[しゅっちょう]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"出張[しゅっちょう]\" (Xizmat safari).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Masu shaklida', "Oddiy lug'at shaklida", 'Ta-shaklida', 'Te-shaklida'],
              correctAnswerIndex: 1,
            ...
            },
            {
              id: 'ja-n4-u4-l1-q4',
              question:
                "Boshqa birovga yoki xo'jayinga «〜つもりですか» deb so'rash nima uchun noo'rin?",
              options: [
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '1. Guruh 1: Oxirgi "u" tovushi "ou" ga o\'zgaradi: 行[い]く -> 行[い]こう, 話[はな]す -> 話[はな]そう. 2. Guruh 2: 食べる -> 食べよう, 見る -> 見よう. 3. Guruh 3: する -> しよう, 来る -> こよう. 4. Niyat bildirish: Fe\'lning xohish shakli + と 思[おも]っています ("... qilmoqchiman / deb o\'ylayapman").',
          keyPoints: [
          ...
          exercises: [
            {
              ...
              options: ['行[い]こう', '行[い]きます', '行[い]よう', '行[い]け'],
              correctAnswer: 0,
          ...
          questions: [
            {
              ...
              options: ['Qani, dam olaylik!', 'Dam olmang', 'Dam olmoqchiman', 'Dam oldik'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['食[た]べろう', '食[た]べ', '食[た]べよう', '食[た]ぼう'],
              correctAnswerIndex: 2,
              explanation: 'Tabeyou.',
            },
            {
    ...
    steps: [
      {
        ...
        learnData: {
          title: '〜から vs 〜ので',
          explanation:
            "1. 〜から: Shaxsiy fikr, buyruq yoki taklif bilan keladi: 時間[じかん]が ありませんから、急[いそ]ぎましょう (Vaqt yo'q, shuning uchun shoshamiz). 2. 〜ので: Ob'ektiv, xushmuomala va uzrli sabab: 電車[でんしゃ]が 遅[おく]れたので、遅刻[ちこく]しました (Poyezd kechikkani sababli kech qoldim).",
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「この 説明[せつめい]は 少[すこ]し 複雑[ふくざつ]です。」",
              options: ['運転[うんてん]', '複雑[ふくざつ]', '散歩[さんぽ]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"複雑[ふくざつ]\" (Murakkab, chigal).",
            },
          ...
          questions: [
            {
              id: 'ja-n4-u4-l3-q1',
              question:
                "Xo'jayin yoki mijozga kech qolish sababini tushuntirganda qaysi biri ko'proq xushmuomala hisoblanadi?",
              options: ['〜から', '〜ので', '〜し', '〜けど'],
              correctAnswerIndex: 1,
  ...
  },
  {
    ...
    description:
      'Shart ergash gaplar: "... bo\'lsa / qilgandan so\'ng" (tara) va umumiy qoida (ba).',
    estimatedDurationMinutes: 15,
    icon: '🔀',
    steps: [
      {
        ...
        learnData: {
          title: '〜たら (If / When)',
          explanation:
            "Fe'lning Ta-shakli + ら (tara): 1. Shart (\"Agar ... bo'lsa\"): 雨[あめ]が 降[ふ]ったら、行[い]きません (Agar yomg'ir yog'sa, bormayman). 2. Vaqt ketma-ketligi (\"Yetib borgach\"): 駅[えき]に 着[つ]いたら、電話[でんわ]してください (Vokzalga yetib borgach, qo'ng'iroq qiling).",
          keyPoints: [
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            '田中[たなか]先生[せんせい]へ。 毎日[まいにち] 暑[あつ]い 日[ひ]が 続[つづ]いて いますが、お元気[げんき]ですか。 さて、来週[らいしゅう]の 日曜日[にちようび]に 学生[がくせい]みんなで 公園[こうえん]で バーベキューを しようと 思[おも]っています。 先生[せんせい]も ぜひ 来[き]て ください。 時間[じかん]は 午前[ごぜん]11時[じゅういちじ]からです。 都合[つごう]が よかったら、金曜日[きんようび]までに お返事[へんじ]を ください。 アリより。',
          keyPoints: [
          ...
          grammarRules: [
            {
              ...
              meaning:
                "Do'stlar va o'qituvchilarga yozilgan xatlar va taklifnomalarni o'qib tushunish.",
              usageNotes:
                '田中[たなか]先生[せんせい]へ。 毎日[まいにち] 暑[あつ]い 日[ひ]が 続[つづ]いて いますが、お元気[げんき]ですか。 さて、来週[らいしゅう]の 日曜日[にちようび]に 学生[がくせい]みんなで 公園[こうえん]で バーベキューを しようと 思[おも]っています。 先生[せんせい]も ぜひ 来[き]て ください。 時間[じかん]は 午前[ごぜん]11時[じゅういちじ]からです。 都合[つごう]が よかったら、金曜日[きんようび]までに お返事[へんじ]を ください。 アリより。',
              examples: [
                {
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「お返事[へんじ]を ください。」",
              options: ['散歩[さんぽ]', '食事[しょくじ]', '運転[うんてん]', '返事[へんじ]'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"返事[へんじ]\" (Javob).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Ali (アリ)', 'Kutubxonachi', 'Shifokor', 'Tanaka san'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['Kim tomonidan yozilganligini', 'Sana', 'Salomlashish', 'Iltimos'],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "1. には (ni wa): ... da esa / ... uchun (\"Toshkentda esa muzeylar ko'p\"). 2. では (de wa): ... da esa (joyda chegaralash). 3. とも (to mo): ... bilan ham. 4. からの (kara no): ... dan bo'lgan (Tomodachi kara no tegami = Do'stimdan kelgan xat).",
          vocabulary: [
            {
              term: '特[とく]に',
              reading: 'Toku ni',
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['Soat nechadan soat nechagacha?', 'Qayerda?', 'Necha pul?', 'Kim bilan?'],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Shifokorga aytish: 熱[ねつ]が あります (Isitma bor), 頭[あたま]が 痛[いた]いです (Boshim og'riyapti), お腹[なか]が 痛[いた]いです (Qornim og'riyapti), 風邪[かぜ]を ひきました (Shamolladim).",
          vocabulary: [
            {
              term: '熱[ねつ]',
              reading: 'Netsu',
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: 'multiple-choice',
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「食後[しょくご]に 薬[くすり]を 飲[の]みます。」",
              options: ['運転[うんてん]', '薬[くすり]', '散歩[さんぽ]', '食事[しょくじ]'],
              correctAnswer: 1,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"薬[くすり]\" (Dori).",
            },
          ],
        },
      },
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ['お大事[だいじ]に', 'ごちそうさま', 'いただきます', 'おめでとうございます'],
              correctAnswerIndex: 0,
            ...
            },
            {
              ...
              options: ['駅[えき]', '大学[だいがく]', '病院[びょういん]', '神社[じんじゃ]'],
              correctAnswerIndex: 2,
  ...
  },
  {
    ...
    description:
      'Vazifaga asoslangan eshitish topshiriqlari: qahramon endi nima qilishi kerakligini aniqlash.',
    estimatedDurationMinutes: 15,
    icon: '🎧',
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "JLPT N4 Choukai bo'limining eng asosiy savol turi: Suhbatdoshlar rejani muhokama qilgandan so'ng, erkak (yoki ayol) kishi BIRINCHI bo'lib nima qilishi kerakligini aniqlash.",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              type: 'multiple-choice',
              prompt:
                'Ayol: «Kserokopiya qilishdan oldin hisobotdagi xatolarni tekshirib bering». Erkak nima qiladi?',
              options: [
                'Hisobotdagi xatolarni tekshiradi',
          ...
          questions: [
            {
              ...
              options: ['Birinchi navbatda / Dastlab', 'Oxirida', 'Hech qachon', 'Tezda'],
              correctAnswerIndex: 0,
            ...
            },
            {
              id: 'ja-n4-u5-l3-q2',
              question:
                "Qahramon boshqa narsani rejalashtirib, keyin «やっぱり (yappari)...» desa, nima sodir bo'ladi?",
              options: [
                'Hech narsa',
            ...
            },
            {
              id: 'ja-n4-u5-l3-q3',
              question:
                "N4 Choukai bo'limida savol varaqa ustida yozilgan bo'ladimi yoki faqat audioda aytiladimi?",
              options: [
                "Faqat kanji bo'ladi",
            ...
            },
            {
              ...
              options: ['Kecha', "O'tgan yili", 'Ertalab', "Bundan so'ng / Shu suhbatdan keyin"],
              correctAnswerIndex: 3,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "N4 darajasida ~300 ta kanji, ~1500 ta so'z va murakkab grammatika (te-form, nai-form, ta-form, potential, conditionals, giving/receiving) sinovdan o'tkaziladi.",
          keyPoints: [
          ...
          exercises: [
            {
              ...
              options: ['教[おし]えない', '教[おし]える', '教[おし]えます', '教[おし]えて'],
              correctAnswer: 3,
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「町[まち]を 案内[あんない]して くれました。」",
              options: ['散歩[さんぽ]', '運転[うんてん]', '食事[しょくじ]', '案内[あんない]します'],
              correctAnswer: 3,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"案内[あんない]します\" (Yoʻl koʻrsatmoq, tanishtirmoq).",
            },
          ...
          questions: [
            {
              ...
              options: ['Sovuq emas', "Sovuq bo'ladi", "Issiq bo'ldi", "Sovuq bo'lib qoldi"],
              correctAnswerIndex: 3,
            ...
            },
            {
              id: 'ja-n4-u5-l4-q2',
              question:
                '「テレビを 見[み]ながら ご飯[はん]を 食[た]べます」dagi 〜ながら nimani bildiradi?',
              options: [
                'Ovqat yemaslik',
                "Faqat televizor ko'rish",
                'Bir vaqtda ikkita ishni bajarish',
                "Televizor yo'qligi",
              ],
              correctAnswerIndex: 2,
            ...
            },
            {
              ...
              options: ["Xonani yorug' qilaman", "Xona yorug' emas", "Xona yo'q", "Xona qorong'i"],
              correctAnswerIndex: 0,
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Tabriklaymiz! Siz N4 darajasidagi barcha grammatik shakllar, iyerogliflar, o'qish va eshitish ko'nikmalarini to'liq o'zlashtirdingiz. Siz endi oraliq N3 darajasiga (Keigo, Passive, Causative, Dokkai) tayyorsiz!",
          keyPoints: [
        ...
        practiceData: {
          ...
          exercises: [
            ...
            },
            {
              ...
              prompt:
                "Quyidagi jumlada qoldirilgan to'g'ri so'zni tanlang: 「試験[しけん]の 準備[じゅんび]を 始[はじ]めましょう。」",
              options: ['準備[じゅんび]', '食事[しょくじ]', '運転[うんてん]', '散歩[さんぽ]'],
              correctAnswer: 0,
              explanation:
                "Jumlaga mazmun jihatidan eng to'g'ri keladigan so'z: \"準備[じゅんび]\" (Tayyorgarlik).",
            },
          ...
          questions: [
            {
              ...
              options: ['もらいました', '貸[か]した', 'くれました', 'あげました'],
              correctAnswerIndex: 2,
            ...
            },
            {
              ...
              options: ['JLPT N1', 'IELTS 7.0', 'JLPT N3', 'A1'],
              correctAnswerIndex: 2,
              explanation: 'JLPT N3.',
            },
          ],
