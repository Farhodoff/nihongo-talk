...
const LEGACY_SAMPLE_LESSONS: Lesson[] = [
  ...
  // ==========================================
  {
    ...
    description:
      "Poyezd, bekat va sayohatga oid asosiy N3 so'zlari hamda 〜ことにする qoidasini o'rganamiz.",
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            "Ushbu darsda Yaponiya bo'ylab sayohat qilishda eng ko'p uchraydigan transport so'zlari va shaxsiy qaror qabul qilish grammatikasi bilan tanishamiz.",
          keyPoints: [
          ...
          grammarRules: [
            {
              ...
              usageNotes:
                "O'z irodasi bilan qaror qabul qilinganda ishlatiladi. O'tgan zamonda: 〜ことにした (qaror qildim).",
              examples: [
                {
          ...
          culturalNotes:
            "Yaponiyada poyezdlar sekundigacha aniqlikda harakatlanadi. Bekatlarda \"乗り換え\" (almashtirish) ko'rsatkichlariga qat'iy e'tibor bering.",
        },
      },
      {
        id: 'ja-n3-u1-l1-s2',
          ...
          exercises: [
            {
              ...
              options: ['きっぷ', 'きふ', 'けっぷ', 'きっぶ'],
              correctAnswer: 0,
              explanation:
                "切 (kiru/setsu) + 符 (fu) birikib, «きっぷ» (kippu - chipta) deb o'qiladi.",
            },
            {
              id: 'ex2',
              type: 'multiple-choice',
              prompt:
                "«Har kuni yapon tilini o'rganishga qaror qildim» jumlasini tuzish uchun qaysi qo'shimcha to'g'ri?",
              options: [
                '勉強する ことにしました',
                '勉強する ようになりました',
                '勉強する はずです',
        ...
        testData: {
          ...
          questions: [
            ...
            },
            {
              ...
              correctAnswerIndex: 0,
              explanation:
                "〜ことにする qoidasidan oldin fe'lning oddiy lug'at shakli (辞書形) keladi: やめる.",
            },
            {
              id: 'tq3',
              ...
              correctAnswerIndex: 0,
              explanation:
                "旅行 (りょこう - ryokou) — sayohat. 料理 (taom), 留学 (chetda o'qish), 約束 (va'da).",
            },
            {
              id: 'tq4',
              question: "Boshqa poyezd liniyasiga o'tish uchun qaysi atama ishlatiladi?",
              options: ['乗り換え', '見送り', '出発', '到着'],
              correctAnswerIndex: 0,
              explanation: '乗り換え (のりかえ - norikae) — transport vositasini almashtirish.',
            },
          ],
        },
      },
  ...
  // ==========================================
  {
    ...
    description:
      "Boshlang'ich A1 darajadagi kundalik odatlar va Present Simple zamonining tuzilishi (Raymond Murphy Unit 2).",
    ...
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            'Present Simple har kuni takrorlanadigan odatlar, haqiqatlar va doimiy holatlar uchun ishlatiladi.',
          keyPoints: [
  ...
  // ==========================================
  {
    ...
    description:
      'Advanced B2 academic vocabulary and grammatical inversion structures with negative adverbials.',
    estimatedDurationMinutes: 15,
    icon: '🎓',
    steps: [
      {
        ...
        learnData: {
          ...
          explanation:
            'In this lesson, we explore high-frequency academic vocabulary for education topics and master grammatical inversion to boost your IELTS Writing and Speaking scores.',
          keyPoints: [
          ...
          vocabulary: [
            ...
            },
            {
              ...
              exampleSentence:
                'The essay requires students to synthesize arguments from multiple sources.',
              exampleTranslation:
                'Insho talabalardan bir nechta manbalardagi dalillarni umumlashtirishni talab qiladi.',
            },
          ],
          grammarRules: [
            {
              ...
              usageNotes:
                "Inversiya (inversion) jumlani akademik va ta'sirchan qiladi. Yordamchi fe'l egadan oldinga o'tadi.",
              examples: [
                {
                  sentence:
                    'Not only did she pass the exam, but she also achieved the highest score.',
                  translation:
                    "U nafaqat imtihondan o'tdi, balki eng yuqori ballni ham qo'lga kiritdi.",
                },
                {
                  sentence: 'Rarely have I witnessed such profound academic dedication.',
                  translation:
                    "Kamdan-kam hollarda bunday chuqur ilmiy fidoyilikka guvoh bo'lganman.",
                },
              ],
            },
          ],
          culturalNotes:
            'In IELTS Writing Task 2, using 1-2 well-placed inversion sentences can significantly improve your Grammatical Range and Accuracy (GRA) score to Band 7.5+.',
        },
      },
      {
        id: 'en-b2-u1-l1-s2',
          ...
          exercises: [
            {
              ...
              type: 'multiple-choice',
              prompt:
                'Choose the word that means "showing great attention to detail and very careful":',
            ...
            },
            {
              ...
              correctAnswer: 0,
              explanation:
                'After negative adverb "Rarely", use auxiliary verb before subject: "have we seen".',
            },
            {
              id: 'en-ex3',
              type: 'multiple-choice',
              ...
              correctAnswer: 0,
              explanation:
                'To synthesize means to combine various components into a connected whole.',
            },
          ],
        },
      },
          ...
          questions: [
            {
              id: 'en-tq1',
              question:
                'What is the noun form describing steady persistence in adhering to a course of action?',
              options: ['Perseverance', 'Hesitation', 'Indifference', 'Reluctance'],
              correctAnswerIndex: 0,
              explanation:
                'Perseverance is continued effort and determination despite difficulties.',
            },
            {
              id: 'en-tq2',
              ...
              correctAnswerIndex: 0,
              explanation:
                '"Not only did he complete..." correctly places the auxiliary "did" before the subject "he".',
            },
            {
              id: 'en-tq3',
            ...
            },
            {
              ...
              correctAnswerIndex: 0,
              explanation:
                '"Little" is a negative adverb, triggering auxiliary inversion: "did they know".',
            },
          ],
        },
      },
