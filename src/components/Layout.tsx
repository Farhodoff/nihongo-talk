...
import { BarChart, BookOpen, Calendar, CheckSquare, ChevronLeft, ChevronRight, Clock, Copy, FileText, Home, Menu, Settings as SettingsIcon, Users, Sparkles, NotebookText, GraduationCap } from 'lucide-react';
