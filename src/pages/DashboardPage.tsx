...
const DashboardPage: React.FC = () => {
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto"> {/* Added max-w for better layout on large screens */}
            <UserRankBadge />

            <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Bugungi Reja</h1>
