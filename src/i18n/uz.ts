export const uz = {
  ...
  admin: {
    ...
    broadcast: "Global E'lon",
    auditLogs: 'Audit Jurnali',
    grantAdmin: 'Admin Qilib Tayinlash',
    revokeAdmin: 'Adminlikni Bekor Qilish',
    contentStudio: 'Kontent Studiyasi',
    speechAnalytics: 'Nutq Tahlili',
    scenarioManager: 'Ssenariylar Boshqaruvi',
    datasetVault: "Ma'lumotlar Ombori",
    searchUsers: 'Foydalanuvchilarni qidirish...',
    userCount: 'foydalanuvchi',
    role: 'Roli',
    registered: "Ro'yxatdan o'tgan",
    lastLogin: 'Oxirgi faollik',
  },
};
