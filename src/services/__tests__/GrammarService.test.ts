      ...
      academic_examples: [
        {
          ...
          translation:
            "2050-yilga kelib tadqiqotchilar global isishni bir asr davomida o'rganayotgan bo'ladilar.",
          context: 'Task 2',
        },
      ],
      common_mistakes: [],
      ...
      select: vi.fn().mockReturnValue({
        eq: vi.fn().mockReturnValue({
          eq: vi.fn().mockReturnValue({
            order: vi
              .fn()
              .mockResolvedValue({ data: null, error: { message: 'Network connection refused' } }),
          }),
        }),
      }),
    });
