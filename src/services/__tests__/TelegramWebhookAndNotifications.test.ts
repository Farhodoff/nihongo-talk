...
// @ts-expect-error JavaScript serverless handler import
import notifyDailyHandler from '../../../api/telegram/notify-daily.js';
...
function createMockRes() {
    const res: any = {
        ...
        json: (d: any) => { res.data = d; return res; },
        end: () => res
    };
    return res;
}
...
describe('Telegram Webhook & Notifications End-to-End Suite', () => {
    ...
    it('5. handles inline callback queries for subscription check', async () => {
        const res = createMockRes();
        const req = {
            method: 'POST',
            headers: {},
    ...
    it('6. formats study reminders and subscription alerts via TelegramService', async () => {
        ...
        const okReminder = await telegramService.sendStudyReminder('00000000-0000-0000-0000-000000000001', 3, 5);
        ...
        const okAlert = await telegramService.sendSubscriptionAlert('00000000-0000-0000-0000-000000000001', 'pro', 2);
